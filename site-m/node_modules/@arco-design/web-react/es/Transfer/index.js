...
function Transfer(baseProps, ref) {
    ...
    var _e = __read(useMemo(function () { return [[], []]; }, [
        dataSource,
        targetKeys,
    ...
    var renderOperations = function () {
        ...
        return simple ? null : (React.createElement("div", { style: operationStyle, className: cs(prefixCls + "-operations", (_a = {},
            ...
            return (React.createElement(Button, { key: index, type: "secondary", size: "small", shape: "round", disabled: _disabled, onClick: function () { return moveTo(to); }, icon: React.createElement(Icon, null) }, operationTexts && operationTexts[index]));
        })));
    };
