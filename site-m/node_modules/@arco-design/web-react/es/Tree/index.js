...
var Tree = /** @class */ (function (_super) {
    ...
    function Tree(props, context) {
        ...
        _this.needUpdateTreeData = function (prevProps, props) {
            ...
            return keys.some(function (key) { return isEqualWith(prevProps[key], props[key]); });
        };
        ...
        _this.handleCheck = function (checked, key, e) {
            ...
            if (checkStrictly) {
                ...
                // 找到所有允许勾选的子节点
                var _b = getAllCheckedKeysByCheck(key, checked, checkedKeys, _this.key2nodeProps, _this.indeterminateKeys), newCheckedKeys = _b.checkedKeys, indeterminateKeys = _b.indeterminateKeys;
