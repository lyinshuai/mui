...
declare const needMergeKeys: readonly ["style", "className", "height", "size", "blockNode", "autoExpandParent", "checkedStrategy", "fieldNames", "icons", "virtualListProps", "showLine", "selectable", "allowDrop"];
...
declare class Tree extends Component<TreeProps, TreeState> {
    ...
    getInitCheckedKeys: (keys: any) => any;
