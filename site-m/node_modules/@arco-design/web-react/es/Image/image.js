...
function Image(baseProps, ref) {
    ...
    var _d = useContext(PreviewGroupContext), previewGroup = _d.previewGroup, setGroupPreviewVisible = _d.setVisible, registerPreviewUrl = _d.registerPreviewUrl, setCurrentId = _d.setCurrentId;
    var previewSrc = previewProps.src || src;
    var id = useMemo(function () { return uuid++; }, []);
    ...
    var defaultError = (React.createElement("div", { className: prefixCls + "-error" },
        ...
        React.createElement("div", { className: prefixCls + "-error-alt" }, alt)));
    ...
    return (React.createElement("div", { className: classNames, style: Object.assign({ width: width }, style), ref: ref },
        React.createElement("img", __assign({ ref: refImg, className: prefixCls + "-img" }, restProps, { title: title, style: { height: height }, onLoad: onImgLoaded, onError: onImgLoadError, onClick: onImgClick })),
