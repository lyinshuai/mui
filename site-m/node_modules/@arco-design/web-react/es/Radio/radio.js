...
function Radio(baseProps) {
    ...
    return (React.createElement("label", __assign({}, omit(rest, ['checked', 'onChange']), { style: style, className: classNames }),
        React.createElement("input", __assign({ disabled: disabled, value: value || '', type: "radio" }, (context.name ? { name: context.name } : {}), { checked: checked, onChange: function (event) {
                event.persist();
                onChange(event);
            }, onClick: function (e) {
                e.stopPropagation();
            } })),
        context.type === 'radio' && (React.createElement(React.Fragment, null,
