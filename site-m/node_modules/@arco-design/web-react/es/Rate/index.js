...
function Rate(baseProps, ref) {
    ...
    var renderCharacter = function (index) {
        ...
        return (React.createElement(CharacterWrapper, __assign({ key: index }, tooltipProps),
            React.createElement("div", { className: classNames, style: animation ? { animationDelay: 50 * index + "ms" } : {}, onAnimationEnd: function () {
                    if (animation && index + 1 >= mergedValue - 1) {
                        setAnimation(false);
                    }
                } },
                React.createElement("div", __assign({ className: prefixCls + "-character-left" }, leftProps), _usedCharacter),
                React.createElement("div", __assign({ className: prefixCls + "-character-right" }, rightProps), _usedCharacter))));
    };
