...
var TextItem = function (props) {
    ...
    return (React.createElement("div", { className: prefixCls + "-list-item " + prefixCls + "-list-item-" + file.status },
        React.createElement("div", { className: cls },
            props.listType === 'picture-list' && (React.createElement("div", { className: cls + "-thumbnail" },
        ...
        React.createElement("div", { className: prefixCls + "-list-item-operation" }, !disabled && actionIcons.removeIcon !== null && (React.createElement(IconHover, null,
            React.createElement("span", { className: prefixCls + "-list-remove-icon", onClick: function () {
