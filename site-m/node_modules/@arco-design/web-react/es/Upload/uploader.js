...
var Uploader = /** @class */ (function (_super) {
    ...
    Uploader.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("input", __assign({ key: "trigger-input", ref: function (node) { return (_this.inputRef = node); }, style: { display: 'none' }, type: "file", accept: accept, multiple: multiple }, (directory ? { webkitdirectory: 'webkitdirectory', directory: 'directory' } : {}), { onChange: function (e) {
            ...
            React.createElement(CSSTransition, { key: "trigger-node", in: !(isNumber(limit) && limit <= fileList.length), timeout: 100, unmountOnExit: true, classNames: "fadeIn" },
