...
var Upload = function (baseProps, ref) {
    ...
    var uploadDom = (React.createElement("div", __assign({}, omit(rest, [
        ...
        'beforeUpload',
            ...
            _a[prefixCls + "-hide"] = isNumber(props.limit) && props.limit <= fileList.length,
            _a), className), style: style }),
        React.createElement(Uploader, __assign({ ref: uploaderRef }, props, { prefixCls: prefixCls, fileList: fileList, onProgress: function (file, e) {
                if (file) {
                    if (!('fileList' in props)) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        showUploadList && (React.createElement(UploadList, { progressProps: progressProps, showUploadList: showUploadList, disabled: disabled, listType: listType, fileList: fileList, renderUploadItem: renderUploadItem, renderUploadList: renderUploadList, onUpload: uploadFile, onAbort: abortFile, onRemove: removeFile, onReupload: reuploadFile, onPreview: props.onPreview, prefixCls: prefixCls })),
        listType === 'picture-card' && uploadDom));
};
