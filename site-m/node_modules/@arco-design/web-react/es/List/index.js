...
function List(baseProps, ref) {
        ...
        var getGrid = function (originItems, render) {
            ...
            if (grid.column || grid.span) {
                ...
                var _loop_1 = function () {
                    ...
                    items.push(React.createElement(Row, { key: currentRow, className: prefixCls + "-row", gutter: gutter, justify: justify, align: align }, currentPageItems.slice(startNum, nextStartNum).map(function (item, index) { return (React.createElement(Col, __assign({ key: currentRow + "_" + index, className: prefixCls + "-row-col" }, colProps_1, { span: span_1 }), render ? render(item, index) : item)); })));
    ...
    var renderList = function () {
        ...
        return (React.createElement("div", { ref: function (_ref) {
            ...
            React.createElement("div", { ref: refScrollList, style: style, className: cs(prefixCls, prefixCls + "-" + size, (_a = {},
                ...
                virtualListProps && Array.isArray(listItems) ? (React.createElement(VirtualList, __assign({ ref: refVirtualList, className: prefixCls + "-content " + prefixCls + "-virtual", data: listItems, isStaticItemHeight: false }, virtualListProps), function (child) { return child; })) : (React.createElement("div", { className: prefixCls + "-content", ref: refItemListWrapper },
                    listItems,
                    onReachBottom && scrollLoading && (React.createElement("div", { className: prefixCls + "-item " + prefixCls + "-scroll-loading" }, scrollLoading)))),
