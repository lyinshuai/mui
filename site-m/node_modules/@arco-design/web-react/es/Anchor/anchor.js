...
function Anchor(baseProps, ref) {
    ...
    function scrollIntoView(hash) {
        ...
        try {
            ...
            var offset = isNumber(boundary) ? boundary : 0;
    ...
    return affix ? (React.createElement(Affix, { offsetTop: offsetTop, offsetBottom: offsetBottom, style: affixStyle }, content)) : (content);
}
