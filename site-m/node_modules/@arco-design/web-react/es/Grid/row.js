...
function Row(baseProps, ref) {
    ...
    return (React.createElement("div", __assign({ ref: ref }, omit(rest, ['gutter']), { style: __assign(__assign({}, style), marginStyle), className: classNames }), React.Children.map(children, function (child) {
        return child
            ? child.type && child.type.displayName === 'Col'
                ? React.cloneElement(child, { gutter: [gutterHorizontal, gutterVertical], div: div })
                : child
            : null;
    })));
}
