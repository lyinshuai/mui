...
function Checkbox(baseProps, ref) {
    ...
    return (React.createElement("label", __assign({ ref: ref }, omit(rest, ['onChange']), { className: classNames, style: style }),
        React.createElement("input", { value: value, disabled: !!disabled, checked: !!checked, onChange: onChange, 
