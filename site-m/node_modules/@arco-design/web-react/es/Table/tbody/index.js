...
function TBody(props) {
    ...
    if (virtualized) {
        if (data.length > 0) {
            return (React.createElement("div", { className: prefixCls + "-body" },
                React.createElement(VirtualList, { data: data, height: scrollStyleY.maxHeight, isStaticItemHeight: false, style: __assign(__assign({}, scrollStyleX), { minWidth: '100%' }) }, function (child, index) { return (React.createElement(Tr, __assign({}, trProps, { key: getRowKey(child), record: child, index: index, level: 0 }))); })));
        }
        return (React.createElement("div", { className: prefixCls + "-body" },
