...
function useColumns(props) {
    ...
    var flattenColumns = useMemo(function () { return getInternalColumns(rows, bodyOperations); }, [
        rows,
        getInternalColumns,
        bodyOperations,
    ]);
    // 把表头分组的 columns 分成 n 行，并且加上 colSpan 和 rowSpan，没有表头分组的话是 1 行。
    var rowCount = useMemo(function () { return getAllHeaderRowsCount(columns, childrenColumnName); }, [
        columns,
        childrenColumnName,
    ]);
    // 分行之后的rows
