...
function Modal(baseProps, ref) {
    ...
    var element = (React.createElement(ConfigProvider, __assign({}, context, { prefixCls: props.prefixCls || context.prefixCls, locale: locale, zIndex: popupZIndex || 1050, getPopupContainer: function (node) {
        ...
        renderFooter(),
        closable &&
            (closeIcon !== undefined ? (React.createElement("span", { onClick: onCancel, className: prefixCls + "-close-icon" }, closeIcon)) : (React.createElement(IconHover, { tabIndex: -1, onClick: onCancel, className: prefixCls + "-close-icon" },
                React.createElement(IconClose, null))))));
    var modalDom = (React.createElement("div", { className: cs(prefixCls, (_a = {},
            _a[prefixCls + "-simple"] = simple,
            _a), className), style: style }, innerFocusLock ? (React.createElement(FocusLock, { disabled: !visible, autoFocus: innerAutoFocus }, element)) : (element)));
    ...
    return (React.createElement(Portal, { visible: visible, forceRender: !mountOnEnter, getContainer: getPopupContainer },
        React.createElement("div", { ref: ref },
            mask ? (React.createElement(CSSTransition, { in: visible, timeout: 400, appear: true, mountOnEnter: mountOnEnter, classNames: "fadeModal", unmountOnExit: unmountOnExit, onEnter: function (e) {
                ...
                React.createElement("div", { className: prefixCls + "-mask", style: maskStyle }))) : null,
            React.createElement("div", __assign({ role: "dialog", "aria-hidden": "true" }, omit(rest, [
                'content',
                'icon',
                'showIcon',
                'isNotice',
                ...
                'closable',
                'prefixCls',
            ]), { ref: modalWrapperRef, className: cs(prefixCls + "-wrapper", (_b = {},
                ...
                React.createElement(CSSTransition, { in: visible, timeout: 400, appear: true, classNames: "zoomModal", unmountOnExit: unmountOnExit, mountOnEnter: mountOnEnter, onEnter: function (e) {
                    ...
                    React.createElement(ConfigProvider, __assign({}, context, { prefixCls: props.prefixCls || context.prefixCls, locale: locale, zIndex: popupZIndex || 1050, getPopupContainer: function (node) {
                            return typeof getChildrenPopupContainer === 'function'
                                ? getChildrenPopupContainer(node)
                                : document.body;
