...
function Timeline(baseProps, ref) {
    ...
    return (React.createElement("div", __assign({}, rest, { ref: ref, className: cs(prefixCls, prefixCls + "-" + mode, prefixCls + "-direction-" + direction, className), style: style }), items.map(function (child, index) {
        var _a;
        if (!child) {
            return null;
        }
