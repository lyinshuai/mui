...
function Menu(baseProps, ref) {
    ...
    var renderChildren = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { className: prefixCls + "-inner" }, mode === 'horizontal' ? React.createElement(OverflowWrap, null, childrenList) : childrenList),
            mergedHasCollapseButton && (React.createElement("div", { className: prefixCls + "-collapse-button", onClick: function () {
    ...
    return (React.createElement("div", __assign({ tabIndex: 1 }, omit(rest, ['isMenu']), { ref: ref, style: usedStyle, className: cs(prefixCls, prefixCls + "-" + theme, prefixCls + "-" + (mode === 'horizontal' ? 'horizontal' : 'vertical'), (_a = {},
