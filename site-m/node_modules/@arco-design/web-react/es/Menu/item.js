...
function Item(props, ref) {
    ...
    var itemElement = (React.createElement(WrapperTagName, __assign({ ref: function (_ref) {
            ref = _ref;
    ...
    return needTooltip ? (React.createElement(Tooltip, __assign({ trigger: "hover", content: React.createElement("span", null, children), position: "right", triggerProps: { className: prefixCls + "-item-tooltip" } }, tooltipProps), itemElement)) : (itemElement);
}
