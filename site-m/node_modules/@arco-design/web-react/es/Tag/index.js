...
function Tag(baseProps, ref) {
    ...
    return (React.createElement("div", __assign({ ref: ref, style: colorStyle, className: classNames }, otherProps),
        ...
        children,
        closable && !loading && closeIcon !== null && (React.createElement(IconHover, { prefix: prefixCls, className: prefixCls + "-close-btn", onClick: onHandleClose }, closeIcon !== undefined ? closeIcon : React.createElement(IconClose, null))),
