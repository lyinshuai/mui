...
function DatePicker(props) {
    ...
    var _b = useContext(ConfigContext), globalLocale = _b.locale, getPrefixCls = _b.getPrefixCls;
    ...
    function renderTimePicker() {
        ...
        return (React.createElement("div", { className: prefixCls + "-timepicker" },
            ...
            React.createElement(TimePicker, __assign({}, timepickerProps, showTimeProps, disabledTimeProps, { hideFooter: true, format: timeFormat, valueShow: timeValue, onSelect: onTimePickerSelect, popupVisible: popupVisible }))));
    }
