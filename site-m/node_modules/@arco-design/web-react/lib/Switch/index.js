...
function Switch(baseProps, ref) {
    ...
    return (react_1.default.createElement("button", __assign({ ref: ref }, extraProps, { style: style, className: classNames, disabled: disabled, onClick: onHandleClick, type: "button" }),
