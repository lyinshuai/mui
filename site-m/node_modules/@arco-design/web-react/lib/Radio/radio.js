...
function Radio(baseProps) {
    ...
    return (react_1.default.createElement("label", __assign({}, (0, omit_1.default)(rest, ['checked', 'onChange']), { style: style, className: classNames }),
        react_1.default.createElement("input", __assign({ disabled: disabled, value: value || '', type: "radio" }, (context.name ? { name: context.name } : {}), { checked: checked, onChange: function (event) {
                event.persist();
                onChange(event);
            }, onClick: function (e) {
                e.stopPropagation();
            } })),
        context.type === 'radio' && (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        context.type === 'button' && react_1.default.createElement("span", { className: prefixCls + "-button-inner" }, children)));
}
