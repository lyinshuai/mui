...
var Option = function (props) {
    ...
    var dom = (react_1.default.createElement("div", { className: prefixCls + "-list-item-label", onClick: option.disabled ? undefined : props.onClickOption, onMouseEnter: option.isLeaf || option.disabled ? undefined : props.onMouseEnter, onDoubleClick: checkboxDisabled ? undefined : props.onDoubleClickOption },
        renderOption ? renderOption() : option.label,
        option.isLeaf ? selected && react_1.default.createElement(IconCheck_1.default, null) : option.loading ? react_1.default.createElement(IconLoading_1.default, null) : react_1.default.createElement(IconRight_1.default, null)));
