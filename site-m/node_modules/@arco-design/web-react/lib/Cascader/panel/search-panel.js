...
var SearchPanel = function (props) {
    ...
    // 保存键盘操作的目标节点
    var _c = __read((0, react_1.useState)(-1), 2), currentHoverIndex = _c[0], setCurrentHoverIndex = _c[1];
        ...
        if (multiple) {
            ...
            if (checked) {
                ...
                checkedValues = value.filter(function (item) {
                    return !(0, isEqualWith_1.default)(item, option.pathValue);
                });
            }
    ...
    return options.length ? (react_1.default.createElement("div", { className: prefixCls + "-list-wrapper" },
        react_1.default.createElement("ul", { onMouseMove: function () {
            ...
            var isChecked = value.some(function (x) {
                return (0, isEqualWith_1.default)(x, item.pathValue);
            });
            return (react_1.default.createElement("li", { ref: function (node) {
                ...
                react_1.default.createElement("div", { className: prefixCls + "-list-item-label" }, multiple ? (react_1.default.createElement(Checkbox_1.default, { checked: isChecked, disabled: item.disabled }, label)) : (react_1.default.createElement(react_1.default.Fragment, null,
                    label,
