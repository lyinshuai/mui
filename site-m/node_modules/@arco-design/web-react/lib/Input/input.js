...
function Input(baseProps, ref) {
    var _a, _b, _c;
    var _d = (0, react_1.useContext)(ConfigProvider_1.ConfigContext), getPrefixCls = _d.getPrefixCls, ctxSize = _d.size, componentConfig = _d.componentConfig;
    ...
    var inputElement = (react_1.default.createElement(input_element_1.default, __assign({ ref: inputRef }, props, { onFocus: function (e) {
            setFocus(true);
            props.onFocus && props.onFocus(e);
        }, onBlur: function (e) {
            setFocus(false);
            props.onBlur && props.onBlur(e);
        }, prefixCls: prefixCls, value: value, onValueChange: onChange, hasParent: !!needWrapper || allowClear, size: size })));
