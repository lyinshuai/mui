...
function Column(_a) {
    ...
    var _l = __read((0, useMergeValue_1.default)([], {
        value: currentFilters[innerDataIndex] || [],
    }), 3), currentFilter = _l[0], setCurrentFilter = _l[1], stateCurrentFilter = _l[2];
    var _m = __read((0, react_1.useState)(false), 2), filterVisible = _m[0], setFilterVisible = _m[1];
    var _o = __read((0, react_1.useState)(false), 2), isEnter = _o[0], setEnter = _o[1];
    ...
    function renderFilters() {
        return typeof filterDropdown === 'function' ? (filterDropdown({
            ...
            react_1.default.createElement("div", { className: prefixCls + "-filters-btn" },
                react_1.default.createElement(Button_1.default, { onClick: handleFilterReset, size: "mini", style: { marginRight: 8 } }, locale.Table.resetText),
    ...
    var _p = (0, useComponent_1.default)(components), ComponentTh = _p.ComponentTh, ComponentHeaderCell = _p.ComponentHeaderCell;
    ...
    var cellChildren = (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        shouldRenderFilters && (react_1.default.createElement(Trigger_1.default, __assign({ popup: renderFilters, trigger: "click", classNames: "slideDynamicOrigin", position: "br", popupAlign: { bottom: 0 }, popupVisible: filterVisible, onVisibleChange: onVisibleChange }, filterDropdownTriggerProps),
