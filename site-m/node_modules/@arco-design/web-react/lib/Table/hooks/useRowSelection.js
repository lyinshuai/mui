...
function useRowSelection(props, data, getRowKey) {
        ...
        var travel = function (children) {
            if ((0, is_1.isArray)(children) && children.length) {
                children.forEach(function (record) {
                    ...
                    if ((0, utils_1.isChildrenNotEmpty)(record, props.childrenColumnName)) {
    ...
    var _b = __read((0, react_1.useState)(getSet(defaultSelectedRowKeys)), 2), selectedRowKeys = _b[0], setSelectedRowKeys = _b[1];
    var _c = __read((0, react_1.useState)(pureKeys ? [] : getRowsFromKeys(selectedRowKeys)), 2), selectedRows = _c[0], setSelectedRows = _c[1];
