...
function TBody(props) {
    ...
    if (virtualized) {
        if (data.length > 0) {
            return (react_1.default.createElement("div", { className: prefixCls + "-body" },
                react_1.default.createElement(VirtualList_1.default, { data: data, height: scrollStyleY.maxHeight, isStaticItemHeight: false, style: __assign(__assign({}, scrollStyleX), { minWidth: '100%' }) }, function (child, index) { return (react_1.default.createElement(tr_1.default, __assign({}, trProps, { key: getRowKey(child), record: child, index: index, level: 0 }))); })));
        }
        return (react_1.default.createElement("div", { className: prefixCls + "-body" },
        ...
        ? data.map(function (record, index) {
            ...
            return (react_1.default.createElement(react_1.default.Fragment, { key: rowK },
                ...
                shouldRenderExpandIcon && (react_1.default.createElement("tr", { className: (0, classNames_1.default)(prefixCls + "-tr", prefixCls + "-expand-content"), key: rowK + "-expanded" },
                    react_1.default.createElement("td", { className: prefixCls + "-td", colSpan: columns.length, style: { paddingLeft: indentSize } }, hasFixedColumn ? (react_1.default.createElement("div", { className: prefixCls + "-expand-fixed-row", style: { width: tableViewWidth } }, expandedRowRender && expandedRowRender(record, index))) : (expandedRowRender && expandedRowRender(record, index)))))));
        })
        : noDataTr));
}
