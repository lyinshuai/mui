...
function Table(baseProps, ref) {
    var _a, _b;
    var _c = (0, react_1.useContext)(ConfigProvider_1.ConfigContext), getPrefixCls = _c.getPrefixCls, loadingElement = _c.loadingElement, ctxSize = _c.size, tablePagination = _c.tablePagination, renderEmpty = _c.renderEmpty, componentConfig = _c.componentConfig;
    ...
    var _g = __read((0, react_1.useState)(1), 2), currentPage = _g[0], setCurrentPage = _g[1];
    var _h = __read((0, react_1.useState)((0, is_1.isObject)(pagination) ? pagination.defaultPageSize || 10 : 10), 2), innerPageSize = _h[0], setInnerPageSize = _h[1];
    var _j = __read((0, react_1.useState)(currentFilters), 2), filters = _j[0], setFilters = _j[1];
    var _k = __read((0, react_1.useState)(currentSorter), 2), sorter = _k[0], setSorter = _k[1];
    var _l = __read((0, react_1.useState)(0), 2), tableViewWidth = _l[0], setTableViewWidth = _l[1];
    var _m = __read((0, useColumns_1.default)(props), 2), groupColumns = _m[0], flattenColumns = _m[1];
    var stickyOffsets = (0, useStickyOffsets_1.default)(flattenColumns);
    var _o = __read((0, useStickyClassNames_1.default)(groupColumns, flattenColumns, prefixCls), 2), groupStickyClassNames = _o[0], stickyClassNames = _o[1];
    var _p = (0, useComponent_1.default)(components), ComponentTable = _p.ComponentTable, ComponentBodyWrapper = _p.ComponentBodyWrapper, ComponentHeaderWrapper = _p.ComponentHeaderWrapper;
    ...
    function getPaginationProps(_processedData) {
        ...
        if ((0, is_1.isObject)(tablePagination)) {
    ...
    function resizeHandler() {
        ...
        if (root && (hasFixedColumn || (scroll && scroll.x))) {
            var tableViewWidth_1 = root.querySelector("." + prefixCls + "-content-inner")
                .clientWidth;
    ...
    var setPositionClassNames = (0, react_1.useCallback)((0, throttle_1.default)(function () {
        ...
        var tbody = (fixedHeader
            ? refTableBody.current
            : refTableNF.current && refTableNF.current.parentNode);
        if (tbody) {
    ...
    var _q = (0, useRowSelection_1.default)(props, pageData, getRowKey), selectedRowKeys = _q.selectedRowKeys, onCheckAll = _q.onCheckAll, onCheck = _q.onCheck, onCheckRadio = _q.onCheckRadio, setSelectedRowKeys = _q.setSelectedRowKeys, allSelectedRowKeys = _q.allSelectedRowKeys, flattenData = _q.flattenData;
    ...
    var _r = __read((0, useExpand_1.default)(props, flattenData, getRowKey), 2), expandedRowKeys = _r[0], onClickExpandBtn = _r[1];
    var scrollStyleY = {};
    var scrollStyleX = {};
    if (scroll) {
    ...
    function setScrollBarStyle() {
        ...
        // TODO: Remove
        setTimeout(function () {
            var scrollBarWidth = (0, utils_1.getScrollBarWidth)(refTableBody.current);
            if (scrollBarWidth) {
    ...
    return (react_1.default.createElement("div", { ref: refTable, style: style, className: classNames },
