...
function PageJumper(props) {
    ...
    var _b = __read((0, react_1.useState)(defaultInputText), 2), current = _b[0], setCurrent = _b[1];
    ...
    return (react_1.default.createElement("div", { className: "" + prefixCls },
        ...
        react_1.default.createElement(Input_1.default, { ref: function (ref) { return (inputRef.current = ref); }, className: prefixCls + "-input", value: !(0, is_1.isUndefined)(inputText) ? inputText.toString() : undefined, size: size, disabled: disabled || !totalPages, onChange: handleChange, onPressEnter: handleJump, onFocus: onFocus, onBlur: handleJump }),
