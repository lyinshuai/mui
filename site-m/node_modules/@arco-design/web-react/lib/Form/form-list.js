...
var List = function (props) {
    ...
    return (react_1.default.createElement(form_item_1.default, __assign({ field: field }, extra, { isFormList: true, noStyle: true, shouldUpdate: function (prev, current, info) {
            ...
            return !(0, isEqualWith_1.default)((0, get_1.default)(prev, field), (0, get_1.default)(current, field));
        } }), function (_, methods) {
