...
var Store = /** @class */ (function () {
    function Store() {
        ...
        this.getRegistedFields = function (hasField) {
            if (hasField) {
        ...
        this.getRegistedField = function (field) {
        ...
        this.getTouchedFields = function () {
            return _this.getRegistedFields(true)
        ...
        this.getFieldError = function (field) {
            var item = _this.getRegistedField(field);
        ...
        this.getFieldsError = function (fields) {
            ...
            if ((0, is_1.isArray)(fields)) {
                ...
                _this.getRegistedFields(true).forEach(function (item) {
                    if (item.getErrors()) {
        ...
        this.getFields = function () {
            var values = (0, utils_1.cloneDeep)(_this.store);
            return values;
        };
        this.getFieldsValue = function (fields) {
            ...
            _this.getRegistedFields(true).forEach(function (_a) {
        ...
        this.validate = (0, promisify_1.default)(function (fieldsOrCallback, cb) {
            ...
            var controlItems = _this.getRegistedFields(true);
    ...
    Store.prototype._inTouchFields = function (field) {
        ...
        return this.touchedFields.some(function (key) {
    ...
    Store.prototype._popTouchField = function (field) {
        ...
        var keys = this._getIterativelyKeysByField(field);
        this.touchedFields = this.touchedFields.filter(function (key) {
            return keys.indexOf(key) === -1;
        });
    };
    Store.prototype._pushTouchField = function (field) {
        this.touchedFields = __spreadArray([], __read(new Set(this.touchedFields.concat(field))), false);
    };
    return Store;
}());
