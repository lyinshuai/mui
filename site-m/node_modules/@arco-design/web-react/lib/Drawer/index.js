...
function Drawer(baseProps, ref) {
    ...
    var style = props.style, className = props.className, children = props.children, wrapClassName = props.wrapClassName, maskStyle = props.maskStyle, headerStyle = props.headerStyle, bodyStyle = props.bodyStyle, title = props.title, footer = props.footer, okText = props.okText, cancelText = props.cancelText, width = props.width, height = props.height, placement = props.placement, mask = props.mask, visible = props.visible, closable = props.closable, maskClosable = props.maskClosable, confirmLoading = props.confirmLoading, mountOnEnter = props.mountOnEnter, unmountOnExit = props.unmountOnExit, afterOpen = props.afterOpen, afterClose = props.afterClose, getPopupContainer = props.getPopupContainer, escToExit = props.escToExit, propGetChildrenPopupContainer = props.getChildrenPopupContainer, focusLock = props.focusLock, autoFocus = props.autoFocus;
    var drawerWrapperRef = (0, react_1.useRef)(null);
    var contentWrapperRef = (0, react_1.useRef)(null);
    var _d = __read((0, react_1.useState)(false), 2), shouldReComputeFixed = _d[0], setShouldReComputeFixed = _d[1];
    var _e = __read((0, react_1.useState)(), 2), popupZIndex = _e[0], setPopupZIndex = _e[1];
    ...
    var _f = __read((0, react_1.useState)(false), 2), isOpened = _f[0], setIsOpened = _f[1];
    ...
    var element = (react_1.default.createElement("div", { className: prefixCls + "-scroll" },
        ...
        footer !== null &&
            (footer ? (react_1.default.createElement("div", { className: prefixCls + "-footer" }, footer)) : (react_1.default.createElement("div", { className: prefixCls + "-footer" },
                react_1.default.createElement(Button_1.default, { onClick: props.onCancel }, cancelText || locale.Drawer.cancelText),
                react_1.default.createElement(Button_1.default, { type: "primary", loading: confirmLoading, onClick: props.onOk }, okText || locale.Drawer.okText))))));
    ...
    var dom = innerFocusLock ? (react_1.default.createElement(react_focus_lock_1.default, { as: "span", disabled: !isOpened, autoFocus: innerAutoFocus }, element)) : (element);
    return (react_1.default.createElement(Portal_1.default, { forceRender: !mountOnEnter, visible: visible, getContainer: getPopupContainer },
        react_1.default.createElement("div", { ref: drawerWrapperRef, className: (0, classNames_1.default)(prefixCls + "-wrapper", (_b = {},
            ...
            mask ? (react_1.default.createElement(react_transition_group_1.CSSTransition, { in: visible, appear: true, timeout: 300, classNames: "fadeInStandard", mountOnEnter: mountOnEnter, unmountOnExit: unmountOnExit },
                react_1.default.createElement("div", { className: prefixCls + "-mask", style: maskStyle, onClick: function () {
            ...
            react_1.default.createElement(react_transition_group_1.CSSTransition, { in: visible, appear: true, timeout: 300, classNames: {
                ...
                react_1.default.createElement("div", { className: (0, classNames_1.default)(prefixCls, className), style: Object.assign(placement === 'left' || placement === 'right' ? { width: width } : { height: height }, (_c = {}, _c[placement] = 0, _c), style) },
