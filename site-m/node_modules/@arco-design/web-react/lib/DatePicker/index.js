...
require("../_util/polyfill/object-assign");
function wrapper(picker, displayName) {
    ...
    return _a = /** @class */ (function (_super) {
            ...
            PickerWrapper.prototype.render = function () {
                return react_1.default.createElement(picker_1.default, __assign({}, this.props, { picker: picker }));
            };
...
var DatePicker = wrapper(react_1.default.createElement(date_1.default, null), 'DatePicker');
var MonthPicker = wrapper(react_1.default.createElement(month_1.default, null), 'MonthPicker');
var YearPicker = wrapper(react_1.default.createElement(year_1.default, null), 'YearPicker');
var WeekPicker = wrapper(react_1.default.createElement(week_1.default, null), 'WeekPicker');
var QuarterPicker = wrapper(react_1.default.createElement(quarter_1.default, null), 'QuarterPicker');
