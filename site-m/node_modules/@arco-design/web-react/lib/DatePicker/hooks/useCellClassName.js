...
function useClassName(props) {
    ...
    var sortedRangeValues = selectedLength !== 2 && hoverLength > 0 ? (0, dayjs_1.getSortedDayjsArray)(valueShowHover) : rangeValues;
    ...
    return function getCellClassName(cellDateObj, disabled) {
        ...
        if (mode === 'quarter') {
            isToday = (0, dayjs_1.getNow)().isSame(cellDateObj.time, 'quarter');
        }
