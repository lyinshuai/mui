...
function RangePicker(props) {
    ...
    function renderDate() {
        ...
        var pickerProps = __assign(__assign({}, basePickerProps), { dayStartOfWeek: dayStartOfWeek, localeName: localeName, popupVisible: popupVisible, timepickerProps: timepickerProps, getHeaderOperations: getHeaderOperations, hideNotInViewDates: hideNotInViewDates, isTimePanel: isTimePanel });
        if (mode === 'week') {
            return (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement(week_1.default, __assign({ setPageShowDate: function (d) { return setRangePageShowDates([d, d], 'week', 0); } }, startOperations, pickerProps, startPickerProps)),
                react_1.default.createElement(week_1.default, __assign({ setPageShowDate: function (d) { return setRangePageShowDates([d, d], 'week', 1); } }, endOperations, pickerProps, endPickerProps))));
        }
        var showTimeProps = {
    ...
    function renderMonth() {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(month_1.default, __assign({ setPageShowDate: function (d) { return setRangePageShowDates([d, d], 'month', 0); } }, startOperations, pickerProps, startPickerProps)),
            react_1.default.createElement(month_1.default, __assign({ setPageShowDate: function (d) { return setRangePageShowDates([d, d], 'month', 1); } }, endOperations, pickerProps, endPickerProps))));
    }
    function renderYear() {
        var startOperations = {
            onSuperPrev: onSuperPrev,
    ...
    function renderQuarter() {
        ...
        var pickerProps = basePickerProps;
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(quarter_1.default, __assign({ setPageShowDate: function (d) { return setRangePageShowDates([d, d], 'quarter', 0); } }, startOperations, pickerProps, startPickerProps)),
            react_1.default.createElement(quarter_1.default, __assign({ setPageShowDate: function (d) { return setRangePageShowDates([d, d], 'quarter', 1); } }, endOperations, pickerProps, endPickerProps))));
    }
