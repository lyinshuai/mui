...
function YearPicker(props) {
    ...
    var _a = (0, react_1.useContext)(ConfigProvider_1.ConfigContext), globalLocale = _a.locale, getPrefixCls = _a.getPrefixCls;
    ...
    var showYear = pageShowDate ? pageShowDate.year() : (0, dayjs_1.getNow)().year();
    ...
    var rows = (0, constant_1.newArray)(4)
        ...
        return arr.map(function (_, j) {
            return {
                ...
                time: (0, dayjs_1.dayjs)("" + (startYear + i * 3 + j), 'YYYY'),
                isPrev: i === 0 && j === 0,
                isNext: i === 3 && j === 2,
            };
        });
    ...
    return (react_1.default.createElement("div", { className: classNames, style: style },
        react_1.default.createElement(header_1.default, __assign({ prefixCls: getPrefixCls('picker'), icons: icons, title: rows[0][1].name + " - " + rows[3][2].name }, headerOperations)),
        renderCalendar()));
}
