...
function Header(props) {
    ...
    function renderHeaderLabel() {
        ...
        if (mode === 'date' || mode === 'week') {
            return (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement("span", { className: prefixCls + "-header-label", onClick: function () { return onChangePanel('year'); } }, value.format('YYYY')),
                "-",
                react_1.default.createElement("span", { className: prefixCls + "-header-label", onClick: function () { return onChangePanel('month'); } }, value.format('MM'))));
        }
    ...
    return (react_1.default.createElement("div", { className: prefixCls + "-header" },
        !prevDoubleNull && (react_1.default.createElement("div", { className: getIconClassName(showSuperPrev), onClick: onSuperPrev }, showSuperPrev && (prevDoubleNull ? null : icons.prevDouble || react_1.default.createElement(IconDoubleLeft_1.default, null)))),
        !prevNull && (react_1.default.createElement("div", { className: getIconClassName(showPrev), onClick: onPrev }, showPrev && (prevNull ? null : icons.prev || react_1.default.createElement(IconLeft_1.default, null)))),
        react_1.default.createElement("div", { className: prefixCls + "-header-value" }, renderHeaderLabel()),
        !nextNull && (react_1.default.createElement("div", { className: getIconClassName(showNext), onClick: onNext }, showNext && (nextNull ? null : icons.next || react_1.default.createElement(IconRight_1.default, null)))),
        !nextDoubleNull && (react_1.default.createElement("div", { className: getIconClassName(showSuperNext), onClick: onSuperNext }, showSuperNext && (nextDoubleNull ? null : icons.nextDouble || react_1.default.createElement(IconDoubleRight_1.default, null))))));
}
