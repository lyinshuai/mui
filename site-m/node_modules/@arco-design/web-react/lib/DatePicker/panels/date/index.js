...
function DatePicker(props) {
    ...
    function renderCalendar() {
        return (react_1.default.createElement(body_1.default, __assign({}, rest, bodyProps, { showWeekList: true, isWeek: isWeek, prefixCls: getPrefixCls('picker'), dayStartOfWeek: dayStartOfWeek, rows: rows, isSameTime: isSameTime || (function (current, target) { return current.isSame(target, 'day'); }), onSelectDate: onSelect, onMouseEnterCell: onMouseEnterCell, onMouseLeaveCell: onMouseLeaveCell, dateRender: dateRender, disabledDate: disabledDate, CALENDAR_LOCALE: DATEPICKER_LOCALE.Calendar, mode: isWeek ? 'week' : 'date', format: format, hideNotInViewDates: hideNotInViewDates })));
    }
    function renderTimePicker() {
        ...
        return (react_1.default.createElement("div", { className: prefixCls + "-timepicker" },
            ...
            react_1.default.createElement(time_picker_1.default, __assign({}, timepickerProps, showTimeProps, disabledTimeProps, { hideFooter: true, format: timeFormat, valueShow: timeValue, onSelect: onTimePickerSelect, popupVisible: popupVisible }))));
    }
    ...
    return (react_1.default.createElement("div", { className: classNames, style: style }, showTime && isTimePanel ? (renderTimePicker()) : (react_1.default.createElement("div", { className: prefixCls + "-inner" },
        react_1.default.createElement(header_1.default, __assign({}, headerOperations, { icons: icons, prefixCls: getPrefixCls('picker'), value: pageShowDate, mode: panelMode, onChangePanel: onChangePanel })),
        renderCalendar()))));
}
