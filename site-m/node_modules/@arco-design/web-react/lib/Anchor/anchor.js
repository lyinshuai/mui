...
function Anchor(baseProps, ref) {
    ...
    function scrollIntoView(hash) {
        ...
        try {
            ...
            var offset = (0, is_1.isNumber)(boundary) ? boundary : 0;
            var actions = (0, compute_scroll_into_view_1.default)(element, { block: block });
            if (!actions.length)
                return;
            var _a = actions[0], el = _a.el, top_2 = _a.top;
            ...
            (0, utils_1.slide)(el, targetTop, function () {
    ...
    var content = (react_1.default.createElement("div", { className: classNames, style: style, ref: wrapperRef },
    ...
    return affix ? (react_1.default.createElement(Affix_1.default, { offsetTop: offsetTop, offsetBottom: offsetBottom, style: affixStyle }, content)) : (content);
}
