...
function Link(baseProps, ref) {
    ...
    var _c = (0, useMergeProps_1.default)(baseProps, defaultProps, componentConfig === null || componentConfig === void 0 ? void 0 : componentConfig['Anchor.Link']), className = _c.className, style = _c.style, href = _c.href, title = _c.title, children = _c.children;
    ...
    return (react_1.default.createElement("div", { className: classNames, style: style, ref: linkRef },
        react_1.default.createElement("a", { className: prefixCls + "-title", title: (0, is_1.isString)(title) ? title : '', href: href, "data-href": href, onClick: function (e) {
