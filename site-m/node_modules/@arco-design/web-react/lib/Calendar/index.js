...
function Calendar(baseProps) {
    var _a;
    var _b = (0, react_1.useContext)(ConfigProvider_1.ConfigContext), getPrefixCls = _b.getPrefixCls, globalLocale = _b.locale, componentConfig = _b.componentConfig;
    ...
    return (react_1.default.createElement("div", { className: classNames, style: __assign(__assign({}, style), baseStyle) },
        ...
        panelTodayBtn && panel && (react_1.default.createElement("div", { className: prefixCls + "-footer-btn-wrapper" }, CALENDAR_LOCALE.today))));
}
