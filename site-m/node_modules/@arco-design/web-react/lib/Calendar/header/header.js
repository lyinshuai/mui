    ...
    return (react_1.default.createElement("div", { className: prefixCls + "-header" },
        react_1.default.createElement("div", { className: prefixCls + "-header-left" },
            isSelectHeaderType ? (react_1.default.createElement(react_1.default.Fragment, null,
                ...
                react_1.default.createElement("div", { className: prefixCls + "-header-icon", onClick: function () { return changePageShowDate('prev', innerMode); } },
                ...
                react_1.default.createElement("div", { className: prefixCls + "-header-icon", onClick: function () { return changePageShowDate('next', innerMode); } },
