...
function AutoComplete(baseProps, ref) {
    ...
    var TriggerElement = react_1.default.cloneElement(triggerElement, __assign(__assign({ ref: function (node) {
            refInput.current = node;
            var originRef = triggerElement.ref;
            if (typeof originRef === 'function') {
                originRef(node);
            }
        }, className: (0, classNames_1.default)("" + prefixCls, inputProps && inputProps.className, className), style: style, value: value, placeholder: placeholder, error: error, disabled: disabled, allowClear: allowClear }, inputProps), { 
