...
function Item(props, ref) {
    ...
    var isActive = (0, hotkey_1.useHotkeyHandler)(_key, function (isActive, type) {
    ...
    var itemElement = (react_1.default.createElement(WrapperTagName, __assign({ ref: function (_ref) {
            ref = _ref;
        ...
        } }, (0, omit_1.default)(rest, ['key', '_key', 'selectable', 'popup'])),
    ...
    return needTooltip ? (react_1.default.createElement(Tooltip_1.default, __assign({ trigger: "hover", content: react_1.default.createElement("span", null, children), position: "right", triggerProps: { className: prefixCls + "-item-tooltip" } }, tooltipProps), itemElement)) : (itemElement);
}
