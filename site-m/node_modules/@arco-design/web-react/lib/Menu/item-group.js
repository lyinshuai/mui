...
function ItemGroup(props, ref) {
    var children = props.children, title = props.title, level = props.level, className = props.className, style = props.style, _key = props._key;
    ...
    var childrenList = (0, util_1.processChildren)(children, {
        _key: _key,
        level: childrenLevel,
    });
