...
exports.isChildrenSelected = exports.processChildren = exports.generateInfoMap = void 0;
...
var processChildren = function (children, props) {
    return react_1.default.Children.map(children, function (item, index) {
        ...
        if (!isMenuSubComponent && item.props.children) {
            ...
            return react_1.default.cloneElement(item, __assign(__assign({}, _props), { _key: item.key, children: (0, exports.processChildren)(item.props.children, props) }));
        }
        return isHTMLElement
            ? item
            : react_1.default.cloneElement(item, __assign(__assign({}, props), { _key: item.key || "$menu-" + index }));
    });
};
