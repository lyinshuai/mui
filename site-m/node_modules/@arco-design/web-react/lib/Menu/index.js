...
function Menu(baseProps, ref) {
    ...
    var refInlineMenuKeys = (0, react_1.useRef)([]);
    ...
    var _f = (0, hotkey_1.useHotkeyListener)({
        openKeys: openKeys,
        selectedKeys: selectedKeys,
        menuInfoMap: menuInfoMap,
        needPause: function () { return mergedCollapse; },
    }), hotkeyInfo = _f.hotkeyInfo, hotkeyListener = _f.listener, clearHotkeyInfo = _f.clear;
    // autoOpen 时，初次渲染展开所有的子菜单
    (0, react_1.useEffect)(function () {
        // 从 openKeys 中过滤已经不存在的 subMenuKey
        var validOpenKeys = openKeys.filter(function (key) { return refInlineMenuKeys.current.indexOf(key) !== -1; });
        if (autoOpen) {
            var keysAdded = refInlineMenuKeys.current.filter(function (key) { return refPrevSubMenuKeys.current.indexOf(key) === -1; });
    ...
    var renderChildren = function () {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement("div", { className: prefixCls + "-inner" }, mode === 'horizontal' ? react_1.default.createElement(overflow_wrap_1.default, null, childrenList) : childrenList),
            mergedHasCollapseButton && (react_1.default.createElement("div", { className: prefixCls + "-collapse-button", onClick: function () {
    ...
    return (react_1.default.createElement("div", __assign({ tabIndex: 1 }, (0, omit_1.default)(rest, ['isMenu']), { ref: ref, style: usedStyle, className: (0, classNames_1.default)(prefixCls, prefixCls + "-" + theme, prefixCls + "-" + (mode === 'horizontal' ? 'horizontal' : 'vertical'), (_a = {},
        ...
        react_1.default.createElement(context_1.default.Provider, { value: {
                ...
                collectInlineMenuKeys: function (key, unmount) {
                    if (unmount) {
                        refInlineMenuKeys.current = refInlineMenuKeys.current.filter(function (x) { return x !== key; });
                    }
                    else {
