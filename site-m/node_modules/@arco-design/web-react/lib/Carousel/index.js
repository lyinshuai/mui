...
function Carousel(baseProps, ref) {
    ...
    var _d = __read((0, react_1.useState)(null), 2), previousIndex = _d[0], setPreviousIndex = _d[1];
    var _e = __read((0, react_1.useState)(false), 2), isPause = _e[0], setIsPause = _e[1];
    var _f = __read((0, react_1.useState)(false), 2), isAnimating = _f[0], setIsAnimating = _f[1];
    var _g = __read((0, react_1.useState)(null), 2), slideDirection = _g[0], setSlideDirection = _g[1];
    ...
    var classNames = (0, classNames_1.default)(prefixCls, prefixCls + "-indicator-position-" + indicatorPosition, className);
    ...
    return (react_1.default.createElement(resizeObserver_1.default, { onResize: computeStyle },
        react_1.default.createElement("div", __assign({ ref: function (_ref) {
            ...
            react_1.default.createElement("div", { ref: refSliderWrapper, style: computedStyle.sliderWrapper, className: (0, classNames_1.default)(prefixCls + "-" + animation, prefixCls + "-" + direction, (_a = {},
            ...
            showArrow !== 'never' && childrenLength > 1 && (react_1.default.createElement(arrow_1.default, { className: arrowClassName, direction: direction, showArrow: showArrow, prev: function () {
                    return slideTo({
