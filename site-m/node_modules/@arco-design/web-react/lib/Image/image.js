...
function Image(baseProps, ref) {
    ...
    var style = props.style, className = props.className, src = props.src, width = props.width, height = props.height, title = props.title, description = props.description, actions = props.actions, footerPosition = props.footerPosition, simple = props.simple, loader = props.loader, loaderClassName = props.loaderClassName, error = props.error, preview = props.preview, _c = props.previewProps, previewProps = _c === void 0 ? {} : _c, alt = props.alt, onClick = props.onClick, restProps = __rest(props, ["style", "className", "src", "width", "height", "title", "description", "actions", "footerPosition", "simple", "loader", "loaderClassName", "error", "preview", "previewProps", "alt", "onClick"]);
    var _d = (0, react_1.useContext)(previewGroupContext_1.PreviewGroupContext), previewGroup = _d.previewGroup, setGroupPreviewVisible = _d.setVisible, registerPreviewUrl = _d.registerPreviewUrl, setCurrentId = _d.setCurrentId;
    var previewSrc = previewProps.src || src;
    var id = (0, react_1.useMemo)(function () { return uuid++; }, []);
    var _e = __read((0, useShowFooter_1.default)({ title: title, description: description, actions: actions }), 1), showFooter = _e[0];
    var _f = (0, useImageStatus_1.default)('beforeLoad'), isLoading = _f.isLoading, isError = _f.isError, isLoaded = _f.isLoaded, setStatus = _f.setStatus;
    ...
    var availablePreviewProps = (0, omit_1.default)(previewProps, [
        'visible',
        'defaultVisible',
        'src',
        'onVisibleChange',
    ...
    (0, react_1.useEffect)(function () {
        if (dom_1.isServerRendering || !refImg.current)
            return;
    ...
    var defaultError = (react_1.default.createElement("div", { className: prefixCls + "-error" },
        ...
        react_1.default.createElement("div", { className: prefixCls + "-error-alt" }, alt)));
    var defaultLoader = (react_1.default.createElement("div", { className: prefixCls + "-loader" },
    ...
    var renderLoader = function () {
        ...
        if (loaderClassName)
            return react_1.default.createElement("div", { className: (0, classNames_1.default)(prefixCls + "-loader", loaderClassName) });
        return loader || null;
    };
    return (react_1.default.createElement("div", { className: classNames, style: Object.assign({ width: width }, style), ref: ref },
        react_1.default.createElement("img", __assign({ ref: refImg, className: prefixCls + "-img" }, restProps, { title: title, style: { height: height }, onLoad: onImgLoaded, onError: onImgLoadError, onClick: onImgClick })),
        ...
        isLoaded && preview && (react_1.default.createElement(image_preview_1.default, __assign({ visible: previewVisible, src: previewSrc }, availablePreviewProps, { onVisibleChange: onPreviewVisibleChange })))));
}
