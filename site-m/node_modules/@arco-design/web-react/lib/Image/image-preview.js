...
function Preview(props, ref) {
    ...
    var className = props.className, style = props.style, src = props.src, defaultVisible = props.defaultVisible, _c = props.maskClosable, maskClosable = _c === void 0 ? true : _c, _d = props.closable, closable = _d === void 0 ? true : _d, _e = props.breakPoint, breakPoint = _e === void 0 ? 316 : _e, actions = props.actions, _f = props.actionsLayout, actionsLayout = _f === void 0 ? [
        ...
        'originalSize',
        'extra',
    ] : _f, _g = props.getPopupContainer, getPopupContainer = _g === void 0 ? function () { return document.body; } : _g, onVisibleChange = props.onVisibleChange;
    var _h = (0, react_1.useContext)(previewGroupContext_1.PreviewGroupContext), previewGroup = _h.previewGroup, previewUrlMap = _h.previewUrlMap, currentId = _h.currentId, setCurrentId = _h.setCurrentId, infinite = _h.infinite;
    var mergedSrc = previewGroup ? previewUrlMap.get(currentId) : src;
    var previewUrlIdList = Array.from(previewUrlMap.keys());
    var currentIndex = previewUrlIdList.indexOf(currentId);
    var _j = __read((0, useMergeValue_1.default)(false, {
        defaultValue: defaultVisible,
        value: props.visible,
    }), 2), visible = _j[0], setVisible = _j[1];
    var _k = (0, react_1.useContext)(ConfigProvider_1.ConfigContext), getPrefixCls = _k.getPrefixCls, locale = _k.locale;
    ...
    var _l = (0, useImageStatus_1.default)('loading'), isLoading = _l.isLoading, isLoaded = _l.isLoaded, setStatus = _l.setStatus;
    var _m = __read((0, react_1.useState)(false), 2), toolbarSimple = _m[0], setToolbarSimple = _m[1];
    var _o = __read((0, react_1.useState)({ x: 0, y: 0 }), 2), translate = _o[0], setTranslate = _o[1];
    var _p = __read((0, react_1.useState)(1), 2), scale = _p[0], setScale = _p[1];
    var _q = __read((0, react_1.useState)(false), 2), scaleValueVisible = _q[0], setScaleValueVisible = _q[1];
    var _r = __read((0, react_1.useState)(0), 2), rotate = _r[0], setRotate = _r[1];
    var _s = __read((0, react_1.useState)(false), 2), moving = _s[0], setMoving = _s[1];
    // Reset image params
    function reset() {
    ...
    var _t = __read((0, react_1.useState)(), 2), container = _t[0], setContainer = _t[1];
    ...
    function jumpTo(index) {
        var previewListLen = previewUrlIdList.length;
        if (infinite) {
        ...
        if (index !== currentIndex && index >= 0 && index <= previewListLen - 1) {
            var nextId = previewUrlIdList[index];
            setCurrentId(nextId);
        }
    }
    function onPrev() {
    ...
    function onZoomIn() {
        var newScale = (0, getScale_1.default)(scale, 'zoomIn');
        onScaleChange(newScale);
    }
    function onZoomOut() {
        var newScale = (0, getScale_1.default)(scale, 'zoomOut');
        onScaleChange(newScale);
    }
    ...
    var defaultActions = [
        ...
        },
        {
            ...
            onClick: onZoomIn,
            disabled: scale === getScale_1.maxScale,
        },
        {
            key: 'zoomOut',
            ...
            onClick: onZoomOut,
            disabled: scale === getScale_1.minScale,
        },
        {
            key: 'originalSize',
    ...
    return (react_1.default.createElement(Portal_1.default, { visible: visible, forceRender: false, getContainer: getContainer },
        react_1.default.createElement(ConfigProvider_1.default, { getPopupContainer: function () { return refWrapper.current; } },
                ...
                visible && (react_1.default.createElement(resizeObserver_1.default, { onResize: onWrapperResize },
                    react_1.default.createElement("div", { ref: refWrapper, className: previewPrefixCls + "-wrapper", onClick: onOutsideImgClick },
                        react_1.default.createElement("div", { ref: refImageContainer, className: previewPrefixCls + "-img-container", style: { transform: "scale(" + scale + ", " + scale + ")" }, onClick: onOutsideImgClick },
                            react_1.default.createElement("img", { ref: refImage, className: (0, classNames_1.default)(previewPrefixCls + "-img", (_b = {},
                                    _b[previewPrefixCls + "-img-moving"] = moving,
                                    _b)), key: mergedSrc, src: mergedSrc, style: {
                        ...
                        previewGroup && (react_1.default.createElement(image_preview_arrow_1.default, { previewCount: previewUrlIdList.length, current: currentIndex, infinite: infinite, onPrev: onPrev, onNext: onNext })))))))));
}
