...
function Spin(baseProps, ref) {
    ...
    var _c = __read((0, react_1.useState)(delay ? false : propLoading), 2), loading = _c[0], setLoading = _c[1];
    ...
    return (react_1.default.createElement("div", { ref: ref, className: (0, classNames_1.default)(prefixCls, (_a = {},
            ...
            _a), className), style: style }, children ? (react_1.default.createElement(react_1.default.Fragment, null,
