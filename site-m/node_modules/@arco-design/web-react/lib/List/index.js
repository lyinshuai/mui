...
function List(baseProps, ref) {
    var _a = (0, react_1.useContext)(ConfigProvider_1.ConfigContext), getPrefixCls = _a.getPrefixCls, loadingElement = _a.loadingElement, ctxSize = _a.size, renderEmpty = _a.renderEmpty, componentConfig = _a.componentConfig;
    ...
    var refScrollList = (0, react_1.useRef)(null);
        ...
        return {
            ...
            scrollIntoView: function (index) {
                if (refVirtualList.current) {
                    refVirtualList.current.scrollTo({ index: index });
                }
    ...
    var throttledScrollHandler = (0, react_1.useCallback)((0, throttle_1.default)(function () {
        ...
        var _a = refScrollList.current, scrollTop = _a.scrollTop, scrollHeight = _a.scrollHeight, clientHeight = _a.clientHeight;
        ...
        var getGrid = function (originItems, render) {
            ...
            if (grid.column || grid.span) {
                ...
                var _loop_1 = function () {
                    var nextStartNum = startNum + rowSize;
                    var currentRow = ~~(startNum / rowSize);
                    items.push(react_1.default.createElement(row_1.default, { key: currentRow, className: prefixCls + "-row", gutter: gutter, justify: justify, align: align }, currentPageItems.slice(startNum, nextStartNum).map(function (item, index) { return (react_1.default.createElement(col_1.default, __assign({ key: currentRow + "_" + index, className: prefixCls + "-row-col" }, colProps_1, { span: span_1 }), render ? render(item, index) : item)); })));
    ...
    var renderList = function () {
        ...
        return (react_1.default.createElement("div", { ref: function (_ref) {
                ref = _ref;
                refDom.current = ref;
            }, style: wrapperStyle, className: (0, classNames_1.default)(prefixCls + "-wrapper", wrapperClassName) },
            react_1.default.createElement("div", { ref: refScrollList, style: style, className: (0, classNames_1.default)(prefixCls, prefixCls + "-" + size, (_a = {},
                    _a[prefixCls + "-no-border"] = !bordered,
                    _a[prefixCls + "-no-split"] = !split,
                    _a[prefixCls + "-hoverable"] = hoverable,
                    _a), className), onScroll: needHandleScroll ? throttledScrollHandler : undefined },
                header ? react_1.default.createElement("div", { className: prefixCls + "-header" }, header) : null,
                virtualListProps && Array.isArray(listItems) ? (react_1.default.createElement(VirtualList_1.default, __assign({ ref: refVirtualList, className: prefixCls + "-content " + prefixCls + "-virtual", data: listItems, isStaticItemHeight: false }, virtualListProps), function (child) { return child; })) : (react_1.default.createElement("div", { className: prefixCls + "-content", ref: refItemListWrapper },
                    listItems,
                    onReachBottom && scrollLoading && (react_1.default.createElement("div", { className: prefixCls + "-item " + prefixCls + "-scroll-loading" }, scrollLoading)))),
