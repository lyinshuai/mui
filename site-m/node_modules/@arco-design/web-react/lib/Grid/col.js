...
function Col(baseProps, ref) {
    ...
    var className = props.className, style = props.style, children = props.children, span = props.span, offset = props.offset, gutter = props.gutter, div = props.div, order = props.order, pull = props.pull, push = props.push, xs = props.xs, sm = props.sm, md = props.md, lg = props.lg, xl = props.xl, xxl = props.xxl, rest = __rest(props, ["className", "style", "children", "span", "offset", "gutter", "div", "order", "pull", "push", "xs", "sm", "md", "lg", "xl", "xxl"]);
    function adaptationGrid(prefixCls, mergeClassName) {
        ...
        Object.keys(screenList).forEach(function (screen) {
            ...
            if (screenValue && (0, is_1.isNumber)(screenValue)) {
                mergeClassName[prefixCls + "-" + screen + "-" + screenValue] = true;
            }
            else if (screenValue && (0, is_1.isObject)(screenValue)) {
    ...
    return (react_1.default.createElement("div", __assign({ ref: ref }, rest, { style: __assign(__assign({}, style), paddingStyle), className: classNames }), children));
}
