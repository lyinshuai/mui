...
function Row(baseProps, ref) {
    ...
    return (react_1.default.createElement("div", __assign({ ref: ref }, (0, omit_1.default)(rest, ['gutter']), { style: __assign(__assign({}, style), marginStyle), className: classNames }), react_1.default.Children.map(children, function (child) {
        return child
            ? child.type && child.type.displayName === 'Col'
                ? react_1.default.cloneElement(child, { gutter: [gutterHorizontal, gutterVertical], div: div })
                : child
            : null;
    })));
}
