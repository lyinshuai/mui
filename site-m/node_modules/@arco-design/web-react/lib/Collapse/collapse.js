...
function Collapse(baseProps, ref) {
    ...
    return (react_1.default.createElement(exports.CollapseContext.Provider, { value: {
        ...
        react_1.default.createElement("div", __assign({ ref: ref }, (0, omit_1.default)(rest, ['activeKey', 'defaultActiveKey']), { className: (0, classNames_1.default)(prefixCls, prefixCls + "-" + (bordered ? 'border' : 'borderless'), className), style: style }), children)));
}
