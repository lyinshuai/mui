...
function ConfigProvider(baseProps) {
    ...
    (0, react_1.useEffect)(function () {
        (0, locale_1.setModalLocale)(locale);
    }, [locale]);
    (0, react_1.useEffect)(function () {
        Message_1.default.config({ prefixCls: prefixCls });
        Notification_1.default.config({ prefixCls: prefixCls });
    }, [prefixCls]);
    ...
    return react_1.default.createElement(exports.ConfigContext.Provider, { value: config }, child);
}
ConfigProvider.ConfigContext = exports.ConfigContext;
