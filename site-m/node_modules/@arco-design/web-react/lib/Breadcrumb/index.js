...
function Breadcrumb(baseProps, ref) {
    ...
    var Ellipses = react_1.default.createElement("span", { className: prefixCls + "-item-ellipses" }, "...");
    var Separator = react_1.default.createElement("span", { className: prefixCls + "-item-separator" }, separator);
    ...
    var getItemsByChildren = function () {
        var delta = react_1.default.Children.toArray(children).length - maxCount;
        return react_1.default.Children.map(children, function (child, index) {
            return (child &&
                getValidChild(react_1.default.cloneElement(child, {
                    prefixCls: prefixCls,
                }), delta, index));
        });
    };
    return (react_1.default.createElement("div", __assign({ ref: ref, style: style, className: (0, classNames_1.default)(prefixCls, className) }, (0, omit_1.default)(rest, ['itemRender'])), routes && routes.length ? getItemsByRoute() : getItemsByChildren()));
}
