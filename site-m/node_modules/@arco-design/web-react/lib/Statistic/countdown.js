...
function Countdown(props, ref) {
    ...
    var _a = __read((0, react_1.useState)((0, util_1.getDateString)(Math.max(dayjsValue.diff(now, 'millisecond'), 0), format)), 2), valueShow = _a[0], setValueShow = _a[1];
    ...
    return (react_1.default.createElement("div", { ref: ref, className: (0, classNames_1.default)("" + prefixCls, prefixCls + "-countdown", className), style: style },
        ...
        react_1.default.createElement("div", { className: prefixCls + "-content" },
            react_1.default.createElement("div", { className: prefixCls + "-value", style: styleValue }, valueShow))));
}
