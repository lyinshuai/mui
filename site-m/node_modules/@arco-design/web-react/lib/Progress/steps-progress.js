...
var StepsProgress = function (props) {
    var _a;
    var size = props.size, prefixCls = props.prefixCls, percent = props.percent, status = props.status, color = props.color, type = props.type, showText = props.showText, formatText = props.formatText;
    ...
    return (react_1.default.createElement("div", { className: cls + "-wrapper" },
        react_1.default.createElement("div", { className: cls + "-outer", style: { height: height } }, __spreadArray([], __read(new Array(props.steps)), false).map(function (_, index) {
            var _a;
...
exports.StepsProgress.defaultProps = {
    showText: true,
    size: 'default',
    status: 'normal',
};
