...
function Progress(baseProps, ref) {
    ...
    return (react_1.default.createElement("div", { ref: ref, className: (0, classNames_1.default)(prefixCls, prefixCls + "-" + type, prefixCls + "-" + size, (_a = {},
        ...
        type === 'circle' && (react_1.default.createElement(circle_progress_1.default, __assign({ width: props.width }, props, { status: status, prefixCls: prefixCls }))),
        type === 'line' &&
            (size === 'mini' ? (react_1.default.createElement(circle_progress_1.default, __assign({}, props, { pathStrokeWidth: strokeWidth || 4, width: width || 16, strokeWidth: strokeWidth || 4, prefixCls: prefixCls, status: status }))) : (react_1.default.createElement(line_progess_1.default, __assign({}, props, { status: status, prefixCls: prefixCls }))))));
}
