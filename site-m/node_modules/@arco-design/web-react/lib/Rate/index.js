...
function Rate(baseProps, ref) {
    ...
    var renderCharacter = function (index) {
        ...
        return (react_1.default.createElement(CharacterWrapper, __assign({ key: index }, tooltipProps),
            react_1.default.createElement("div", { className: classNames, style: animation ? { animationDelay: 50 * index + "ms" } : {}, onAnimationEnd: function () {
                    if (animation && index + 1 >= mergedValue - 1) {
                        setAnimation(false);
                    }
                } },
                react_1.default.createElement("div", __assign({ className: prefixCls + "-character-left" }, leftProps), _usedCharacter),
                react_1.default.createElement("div", __assign({ className: prefixCls + "-character-right" }, rightProps), _usedCharacter))));
    };
