...
function ResizeBox(baseProps, ref) {
    ...
    var _b = __read((0, react_1.useState)({}), 2), paddingStyles = _b[0], setPaddingStyles = _b[1];
    var _c = __read((0, useMergeValue_1.default)(undefined, { value: propWidth }), 2), width = _c[0], setWidth = _c[1];
    var _d = __read((0, useMergeValue_1.default)(undefined, { value: propHeight }), 2), height = _d[0], setHeight = _d[1];
    ...
    var Tag = component;
    return (react_1.default.createElement(Tag, { style: wrapperStyles, className: classNames, ref: wrapperRef },
        children,
