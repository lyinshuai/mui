...
function Checkbox(baseProps, ref) {
    ...
    return (react_1.default.createElement("label", __assign({ ref: ref }, (0, omit_1.default)(rest, ['onChange']), { className: classNames, style: style }),
        react_1.default.createElement("input", { value: value, disabled: !!disabled, checked: !!checked, onChange: onChange, 
        ...
        react_1.default.createElement(icon_hover_1.default, { prefix: prefixCls, className: prefixCls + "-mask-wrapper", disabled: checked || disabled || indeterminate },
            react_1.default.createElement("div", { className: prefixCls + "-mask" },
                react_1.default.createElement(icon_check_1.default, { className: prefixCls + "-mask-icon" }))),
