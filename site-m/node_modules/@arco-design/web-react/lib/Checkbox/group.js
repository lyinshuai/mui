...
exports.CheckboxGroupContext = (0, react_1.createContext)({
...
function Group(props) {
    ...
    return (react_1.default.createElement("span", { className: classNames, style: style },
        react_1.default.createElement(exports.CheckboxGroupContext.Provider, { value: {
            ...
            ? options.map(function (option) {
                ...
                return (react_1.default.createElement(checkbox_1.default, { disabled: disabled || ((0, is_1.isObject)(option) && option.disabled), key: checkValue, value: checkValue }, label));
            })
            : children)));
}
