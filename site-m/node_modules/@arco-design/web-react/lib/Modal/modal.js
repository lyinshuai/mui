...
function Modal(baseProps, ref) {
    ...
    var _e = __read((0, react_1.useState)(visible), 2), wrapperVisible = _e[0], setWrapperVisible = _e[1];
    ...
    var locale = (0, locale_1.getModalLocale)();
    // 简洁模式下默认不显示关闭按钮
    ...
    var renderFooter = function () {
        ...
        var footerContent = footer || (react_1.default.createElement(react_1.default.Fragment, null,
            !hideCancel && cancelButtonNode,
            okButtonNode));
        if ((0, is_1.isFunction)(footer)) {
    ...
    var element = (react_1.default.createElement(ConfigProvider_1.default, __assign({}, context, { prefixCls: props.prefixCls || context.prefixCls, locale: locale, zIndex: popupZIndex || 1050, getPopupContainer: function (node) {
        ...
        renderFooter(),
        closable &&
            (closeIcon !== undefined ? (react_1.default.createElement("span", { onClick: onCancel, className: prefixCls + "-close-icon" }, closeIcon)) : (react_1.default.createElement(icon_hover_1.default, { tabIndex: -1, onClick: onCancel, className: prefixCls + "-close-icon" },
                react_1.default.createElement(IconClose_1.default, null))))));
    var modalDom = (react_1.default.createElement("div", { className: (0, classNames_1.default)(prefixCls, (_a = {},
            _a[prefixCls + "-simple"] = simple,
            _a), className), style: style }, innerFocusLock ? (react_1.default.createElement(react_focus_lock_1.default, { disabled: !visible, autoFocus: innerAutoFocus }, element)) : (element)));
    ...
    return (react_1.default.createElement(Portal_1.default, { visible: visible, forceRender: !mountOnEnter, getContainer: getPopupContainer },
        react_1.default.createElement("div", { ref: ref },
            mask ? (react_1.default.createElement(react_transition_group_1.CSSTransition, { in: visible, timeout: 400, appear: true, mountOnEnter: mountOnEnter, classNames: "fadeModal", unmountOnExit: unmountOnExit, onEnter: function (e) {
                ...
                react_1.default.createElement("div", { className: prefixCls + "-mask", style: maskStyle }))) : null,
            react_1.default.createElement("div", __assign({ role: "dialog", "aria-hidden": "true" }, (0, omit_1.default)(rest, [
                'content',
                'icon',
                'showIcon',
                'isNotice',
                ...
                'closable',
                'prefixCls',
            ]), { ref: modalWrapperRef, className: (0, classNames_1.default)(prefixCls + "-wrapper", (_b = {},
                    ...
                    display: visible || wrapperVisible ? 'block' : 'none', overflow: !visible && wrapperVisible ? 'hidden' : '' }), onMouseDown: function (e) {
                ...
                react_1.default.createElement(react_transition_group_1.CSSTransition, { in: visible, timeout: 400, appear: true, classNames: "zoomModal", unmountOnExit: unmountOnExit, mountOnEnter: mountOnEnter, onEnter: function (e) {
                    ...
                    react_1.default.createElement(ConfigProvider_1.default, __assign({}, context, { prefixCls: props.prefixCls || context.prefixCls, locale: locale, zIndex: popupZIndex || 1050, getPopupContainer: function (node) {
                            return typeof getChildrenPopupContainer === 'function'
                                ? getChildrenPopupContainer(node)
                                : document.body;
