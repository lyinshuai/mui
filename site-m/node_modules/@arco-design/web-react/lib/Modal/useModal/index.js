...
var contextHolder_1 = __importDefault(require("./contextHolder"));
...
function useModal() {
    ...
    function addNewModal(config) {
        ...
        var simpleModal = (react_1.default.createElement(hookModal_1.default, __assign({ key: uuid, ref: modalRef }, (0, confirm_1.normalizeConfig)(config), { afterClose: afterClose })));
