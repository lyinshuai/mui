...
var normalizeConfig = function (_config) {
    if (_config.isNotice) {
        ...
        _config.title = (react_1.default.createElement("span", null,
            icon,
            _config.title));
        ...
        _config.title = (react_1.default.createElement("span", null,
            _config.icon !== null && (_config.icon || react_1.default.createElement(IconExclamationCircleFill_1.default, null)),
            _config.title));
    }
    return _config;
};
...
function confirm(config, renderFunc) {
    ...
    function render(props) {
        react_dom_1.default.render(react_1.default.createElement(ConfirmModal, __assign({}, props, { onCancel: onCancel })), div);
    }
    ...
    renderFunction(modalConfig);
    function destroy() {
        var unmountEle = react_dom_1.default.unmountComponentAtNode(div);
