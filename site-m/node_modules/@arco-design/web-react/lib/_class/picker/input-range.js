...
function DateInput(_a, ref) {
    ...
    var _e = (0, react_1.useContext)(ConfigProvider_1.ConfigContext), getPrefixCls = _e.getPrefixCls, ctxSize = _e.size, locale = _e.locale;
    ...
    var getInputValue = function (index) {
        var valueText = value[index] ? value[index].locale(localeName).format(format) : '';
        if (inputValue) {
