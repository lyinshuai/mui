...
var IconExpand_1 = __importDefault(require("../../icon/react-icon-cjs/IconExpand"));
...
var SelectView = function (props, ref) {
    var _a, _b;
    var style = props.style, className = props.className, size = props.size, bordered = props.bordered, allowClear = props.allowClear, allowCreate = props.allowCreate, error = props.error, loading = props.loading, disabled = props.disabled, animation = props.animation, prefixCls = props.prefixCls, suffixIcon = props.suffixIcon, arrowIcon = props.arrowIcon, removeIcon = props.removeIcon, placeholder = props.placeholder, renderText = props.renderText, value = props.value, inputValue = props.inputValue, popupVisible = props.popupVisible, maxTagCount = props.maxTagCount, isMultiple = props.isMultiple, isEmptyValue = props.isEmptyValue, prefix = props.prefix, renderTag = props.renderTag, onKeyDown = props.onKeyDown, onChangeInputValue = props.onChangeInputValue, onPaste = props.onPaste, onClear = props.onClear, onFocus = props.onFocus, onBlur = props.onBlur, onRemoveCheckedItem = props.onRemoveCheckedItem, rest = __rest(props, ["style", "className", "size", "bordered", "allowClear", "allowCreate", "error", "loading", "disabled", "animation", "prefixCls", "suffixIcon", "arrowIcon", "removeIcon", "placeholder", "renderText", "value", "inputValue", "popupVisible", "maxTagCount", "isMultiple", "isEmptyValue", "prefix", "renderTag", "onKeyDown", "onChangeInputValue", "onPaste", "onClear", "onFocus", "onBlur", "onRemoveCheckedItem"]);
    // refs
    ...
    var mergedArrowIcon = 'arrowIcon' in props ? (arrowIcon === null ? null : (react_1.default.createElement("div", { className: prefixCls + "-arrow-icon" }, arrowIcon))) : canFocusInput ? (react_1.default.createElement("div", { className: prefixCls + "-expand-icon" },
        react_1.default.createElement(IconExpand_1.default, { style: { transform: 'rotate(-45deg)' } }))) : (react_1.default.createElement("div", { className: prefixCls + "-arrow-icon" },
    ...
    var renderSingle = function () {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(input_element_1.default, __assign({ ref: refInput, disabled: disabled, className: (0, classNames_1.default)(prefixCls + "-view-input", (_a = {},
                    _a[prefixCls + "-hidden"] = !needShowInput,
                    _a)) }, inputProps)),
            react_1.default.createElement("span", { className: (0, classNames_1.default)(prefixCls + "-view-value", (_b = {}, _b[prefixCls + "-hidden"] = needShowInput, _b)) }, _inputValue)));
    };
    var renderMultiple = function () {
        ...
        var tagsToShow = usedValue.slice(0, usedMaxTagCount).map(function (v) {
        ...
        , __assign({ 
            // Avoid when clicking outside the browser window, InputTag out of focus
            className: mergedFocused ? getPrefixCls('input-tag') + "-focus" : '', ref: refInput, disabled: disabled, disableInput: !showSearch, animation: animation, placeholder: placeholder, value: tagsToShow, inputValue: inputValue, size: mergedSize, tagClassName: prefixCls + "-tag", renderTag: renderTag, icon: { removeIcon: removeIcon } }, eventHandlers)));
    };
    var classNames = (0, classNames_1.default)(prefixCls, prefixCls + "-" + (isMultiple ? 'multiple' : 'single'), (_a = {},
        ...
        _a), className);
    var clearIcon = !disabled && !isEmptyValue && allowClear ? (react_1.default.createElement(icon_hover_1.default, { size: mergedSize, key: "clearIcon", className: prefixCls + "-clear-icon", onClick: onClear, onMouseDown: keepFocus },
        react_1.default.createElement(IconClose_1.default, null))) : null;
    return (react_1.default.createElement("div", __assign({}, (0, include_1.default)(rest, ['onClick', 'onMouseEnter', 'onMouseLeave']), { ref: refWrapper, tabIndex: disabled ? -1 : 0, style: style, className: classNames, 
        ...
        react_1.default.createElement("div", { title: typeof renderedValue === 'string' ? renderedValue : undefined, className: (0, classNames_1.default)(prefixCls + "-view", (_b = {},
            ...
            prefix && (react_1.default.createElement("div", { className: (0, classNames_1.default)(prefixCls + "-prefix"), onMouseDown: function (event) { return focused && keepFocus(event); } }, prefix)),
            isMultiple ? renderMultiple() : renderSingle(),
            react_1.default.createElement("div", { className: prefixCls + "-suffix", onMouseDown: function (event) { return focused && keepFocus(event); } },
                clearIcon,
                mergedSuffixIcon))));
};
