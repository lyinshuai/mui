...
function Button(baseProps, ref) {
    ...
    return (react_1.default.createElement(Button_1.default.Group, { className: className, style: style, ref: ref },
        leftButton,
        react_1.default.createElement(index_1.default, { droplist: droplist, position: position, trigger: trigger, unmountOnExit: unmountOnExit, onVisibleChange: onVisibleChange, triggerProps: {
