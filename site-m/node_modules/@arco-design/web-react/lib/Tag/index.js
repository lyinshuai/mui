...
function Tag(baseProps, ref) {
    ...
    var className = props.className, style = props.style, children = props.children, color = props.color, closable = props.closable, checkable = props.checkable, defaultChecked = props.defaultChecked, size = props.size, onClose = props.onClose, onCheck = props.onCheck, icon = props.icon, closeIcon = props.closeIcon, rest = __rest(props, ["className", "style", "children", "color", "closable", "checkable", "defaultChecked", "size", "onClose", "onCheck", "icon", "closeIcon"]);
    ...
    return (react_1.default.createElement("div", __assign({ ref: ref, style: colorStyle, className: classNames }, otherProps),
        ...
        children,
        closable && !loading && closeIcon !== null && (react_1.default.createElement(icon_hover_1.default, { prefix: prefixCls, className: prefixCls + "-close-btn", onClick: onHandleClose }, closeIcon !== undefined ? closeIcon : react_1.default.createElement(IconClose_1.default, null))),
