...
function isSelectOption(child) {
    return (0, get_1.default)(child, 'props.isSelectOption');
}
exports.isSelectOption = isSelectOption;
function isSelectOptGroup(child) {
    return (0, get_1.default)(child, 'props.isSelectOptGroup');
}
            ...
            arr.forEach(function (option) {
                option =
                    (0, is_1.isString)(option) || (0, is_1.isNumber)(option)
                        ...
                        : option;
                var child = (react_1.default.createElement(option_1.default, { _key: getChildKey(option), value: option.value, disabled: option.disabled === true, extra: option.extra }, option.label));
