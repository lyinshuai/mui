...
import { OptionInfo, OptionProps, SelectProps } from './interface';
...
declare function getValidValue(value: any, isMultiple: boolean, labelInValue: boolean): SelectProps['value'];
