...
var Marks = function (props) {
    var _a = props.data, data = _a === void 0 ? [] : _a, min = props.min, max = props.max, vertical = props.vertical, prefixCls = props.prefixCls, reverse = props.reverse;
    if (!data.length)
        return null;
    return (react_1.default.createElement("div", { className: prefixCls + "-marks" }, data.map(function (_a) {
        ...
        return ((0, utils_1.isNotEmpty)(dom) && (react_1.default.createElement("div", { className: prefixCls + "-marks-text", key: key, style: vertical
