...
var SliderButton = function (props) {
    ...
    var position = (0, react_1.useMemo)(function () { return tooltipPosition || (vertical ? 'right' : 'top'); }, [
        tooltipPosition,
        vertical,
    ]);
    ...
    function renderTooltipContent(position) {
        ...
        return (react_1.default.createElement("div", { className: (0, classNames_1.default)(tooltipPrefixCls + "-content", tooltipPrefixCls + "-content-" + position), onMouseLeave: handleMouseLeave, onMouseEnter: handlePopupMouseEnter, onClick: function (e) {
            ...
            react_1.default.createElement("div", { className: tooltipPrefixCls + "-content-inner" }, (0, is_1.isFunction)(formatTooltip) ? formatTooltip(value) : value)));
    }
    ...
    return (react_1.default.createElement(Trigger_1.default, { style: { maxWidth: 350 }, classNames: "zoomInFadeOut", duration: {
        ...
        react_1.default.createElement("div", { className: (0, classNames_1.default)(prefixCls + "-button", (_a = {}, _a[prefixCls + "-button-active"] = isActive, _a)), onMouseDown: handleMouseDown, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, style: style })));
};
