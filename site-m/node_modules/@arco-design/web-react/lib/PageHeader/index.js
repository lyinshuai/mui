...
function PageHeader(baseProps) {
    ...
    return (react_1.default.createElement(resizeObserver_1.default, { onResize: function () {
        ...
        react_1.default.createElement("div", { ref: pageRef, className: (0, classNames_1.default)("" + prefixCls, (_a = {},
            ...
            react_1.default.createElement("div", { className: prefixCls + "-head-wrapper" },
                ...
                react_1.default.createElement("div", { className: prefixCls + "-head" },
                    react_1.default.createElement("div", { className: (0, classNames_1.default)(prefixCls + "-head-main", (_b = {},
                            ...
                            _b)) },
                        backIcon && (react_1.default.createElement(icon_hover_1.default, { prefix: prefixCls, className: prefixCls + "-back", onClick: props.onBack },
                            react_1.default.createElement("span", { className: prefixCls + "-back-icon" }, backIcon === true ? react_1.default.createElement(IconLeft_1.default, null) : backIcon))),
