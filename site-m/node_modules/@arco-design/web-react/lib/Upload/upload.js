...
var processFile = function (fileList) {
    var res = {};
    if (!(0, is_1.isArray)(fileList)) {
        return res;
    }
    fileList.forEach(function (file, index) {
        if (file.uid) {
            res[file.uid] = __assign({ status: interface_1.STATUS.success, percent: 100 }, file);
        }
        else {
            var uid = "" + String(+new Date()) + index;
            res[uid] = __assign(__assign({}, file), { uid: uid, status: interface_1.STATUS.success, percent: 100 });
        }
    });
    return res;
};
...
var Upload = function (baseProps, ref) {
    ...
    var uploadState = (0, react_1.useRef)({});
    var _c = __read((0, react_1.useState)('fileList' in props
        ...
        return {
            submit: function (file) {
                ...
                if (file) {
                    ...
                    list = getFileList(uploadState.current).filter(function (x) { return x.status === interface_1.STATUS.init; });
                }
    ...
    var uploadDom = (react_1.default.createElement("div", __assign({}, (0, omit_1.default)(rest, [
        ...
        'beforeUpload',
            ...
            _a[prefixCls + "-hide"] = (0, is_1.isNumber)(props.limit) && props.limit <= fileList.length,
            _a), className), style: style }),
        react_1.default.createElement(uploader_1.default, __assign({ ref: uploaderRef }, props, { prefixCls: prefixCls, fileList: fileList, onProgress: function (file, e) {
                if (file) {
                    if (!('fileList' in props)) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        showUploadList && (react_1.default.createElement(index_1.default, { progressProps: progressProps, showUploadList: showUploadList, disabled: disabled, listType: listType, fileList: fileList, renderUploadItem: renderUploadItem, renderUploadList: renderUploadList, onUpload: uploadFile, onAbort: abortFile, onRemove: removeFile, onReupload: reuploadFile, onPreview: props.onPreview, prefixCls: prefixCls })),
        listType === 'picture-card' && uploadDom));
};
