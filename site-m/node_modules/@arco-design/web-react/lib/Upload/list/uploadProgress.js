...
var UploadProgress = function (props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        status === interface_1.STATUS.fail && props.reuploadIcon !== null && (react_1.default.createElement("span", { className: prefixCls + "-list-reupload-icon", onClick: function () {
        ...
        status !== interface_1.STATUS.success && (react_1.default.createElement("div", { className: cls + "-status", style: widthStyle },
            ...
            status === interface_1.STATUS.init && props.startIcon !== null && (react_1.default.createElement("span", { className: prefixCls + "-list-start-icon", onClick: function () {
            ...
            status === interface_1.STATUS.uploading && props.cancelIcon !== null && (react_1.default.createElement("span", { className: props.prefixCls + "-list-cancel-icon", onClick: function () {
