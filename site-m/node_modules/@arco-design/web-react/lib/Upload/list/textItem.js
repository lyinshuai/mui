...
var TextItem = function (props) {
    ...
    return (react_1.default.createElement("div", { className: prefixCls + "-list-item " + prefixCls + "-list-item-" + file.status },
        react_1.default.createElement("div", { className: cls },
            props.listType === 'picture-list' && (react_1.default.createElement("div", { className: cls + "-thumbnail" },
        ...
        react_1.default.createElement("div", { className: prefixCls + "-list-item-operation" }, !disabled && actionIcons.removeIcon !== null && (react_1.default.createElement(icon_hover_1.default, null,
            react_1.default.createElement("span", { className: prefixCls + "-list-remove-icon", onClick: function () {
