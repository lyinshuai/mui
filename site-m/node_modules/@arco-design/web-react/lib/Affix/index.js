...
function Affix(baseProps, ref) {
    ...
    var classNames = (0, classNames_1.default)((_a = {}, _a[prefixCls] = isFixed, _a), affixClassName);
    ...
    return (react_1.default.createElement(resizeObserver_1.default, { onResize: updatePosition },
        react_1.default.createElement("div", { className: (0, classNames_1.default)(className), style: style, ref: wrapperRef },
