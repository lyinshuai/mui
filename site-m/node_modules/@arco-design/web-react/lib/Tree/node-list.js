...
function NodeList(props, ref) {
    ...
    var calcChildrenList = (0, react_1.useCallback)(function () {
        return nodeList.filter(function (item) {
            ...
            saveCacheNode(react_1.default.createElement(node_1.default, __assign({}, item, getNodeProps(item), { key: item.key })));
            return false;
        });
    ...
    return isVirtual ? (react_1.default.createElement(VirtualList_1.default, __assign({ className: className, style: style, ref: virtualListRef, data: childrenList, isStaticItemHeight: false, itemKey: getKey }, virtualListProps), function (item) {
        var node = react_1.default.createElement(node_1.default, __assign({}, item, getNodeProps(item, expandedKeysSet), { key: item.key }));
        saveCacheNode(node);
        return node;
    })) : (react_1.default.createElement("div", { className: className, style: style, ref: treeWrapperRef }, childrenList.map(function (item) {
        var node = react_1.default.createElement(node_1.default, __assign({}, item, getNodeProps(item, expandedKeysSet), { key: item.key }));
        saveCacheNode(node);
        return node;
    })));
