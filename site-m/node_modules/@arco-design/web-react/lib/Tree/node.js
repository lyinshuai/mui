...
function TreeNode(props, ref) {
    ...
    var getPrefixIcon = function () {
        ...
        if (icon) {
            icon = (react_1.default.createElement("span", { className: prefixCls + "-switcher-icon", onClick: switchExpandStatus }, icon));
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { style: props.style, className: classNames, ref: ref },
            react_1.default.createElement("span", { className: prefixCls + "-indent" }, __spreadArray([], __read(Array(props._level)), false).map(function (_, i) {
                var _a;
            ...
            react_1.default.createElement("span", { className: (0, classNames_1.default)(prefixCls + "-switcher", (_b = {},
                    ...
                    _b)) }, getPrefixIcon()),
            checkable ? (react_1.default.createElement(Checkbox_1.default, { disabled: disableCheckbox || disabled, value: _key, indeterminate: props.indeterminated, checked: props.checked, onChange: function (checked, e) {
            ...
            react_1.default.createElement("span", { ref: nodeTitleRef, className: (0, classNames_1.default)(prefixCls + "-title", (_c = {},
