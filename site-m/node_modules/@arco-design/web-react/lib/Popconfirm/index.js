...
function Popconfirm(baseProps, ref) {
    var _a = (0, react_1.useContext)(ConfigProvider_1.ConfigContext), getPrefixCls = _a.getPrefixCls, locale = _a.locale, componentConfig = _a.componentConfig;
    ...
    var renderPopconfirmContent = function () {
        ...
        return (react_1.default.createElement("div", { className: prefixCls + "-wrapper" },
            ...
            react_1.default.createElement("div", { className: prefixCls + "-btn" }, focusLock ? (react_1.default.createElement(react_focus_lock_1.default, { disabled: !popupVisible, autoFocus: !!autoFocus }, element)) : (element))));
    };
