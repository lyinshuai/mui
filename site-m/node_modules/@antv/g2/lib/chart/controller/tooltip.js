...
var Tooltip = /** @class */ (function (_super) {
    ...
    Tooltip.prototype.showTooltip = function (point) {
        ...
        view.emit('tooltip:show', event_1.default.fromData(view, 'tooltip:show', (0, tslib_1.__assign)({ items: items, title: title }, point)));
        ...
        if (!(0, util_1.isEqual)(lastTitle, title) || !(0, util_1.isEqual)(lastItems, items)) {
            // 内容发生变化了更新 tooltip
            view.emit('tooltip:change', event_1.default.fromData(view, 'tooltip:change', (0, tslib_1.__assign)({ items: items, title: title }, point)));
    ...
    Tooltip.prototype.processCustomContent = function (option) {
        ...
        return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, option), { customContent: customContent });
    };
    ...
    Tooltip.prototype.renderTooltip = function () {
        ...
        var cfg = this.getTooltipCfg();
        var tooltip = new dependents_1.HtmlTooltip((0, tslib_1.__assign)((0, tslib_1.__assign)({ parent: canvas.get('el').parentNode, region: region }, cfg), { visible: false, crosshairs: null }));
        tooltip.init();
    ...
    Tooltip.prototype.renderTooltipMarkers = function (items, marker) {
        ...
        for (var _i = 0, items_3 = items; _i < items_3.length; _i++) {
            ...
            var attrs = (0, tslib_1.__assign)((0, tslib_1.__assign)({ fill: item.color, symbol: 'circle', shadowColor: item.color }, marker), { x: x, y: y });
