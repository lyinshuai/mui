...
var SvgMorph = function SvgMorph(value, key) {
  ...
  (0, _classCallCheck2.default)(this, SvgMorph);
  this.value = value;
  this.key = key;
  this.start = '';
  this.vars = {};
  ...
  this.getAnimStart = function () {
    ...
    if (startAt[key]) {
      if ((0, _typeof2.default)(startAt[key]) === 'object') {
    ...
    if (tagName === 'polygon' || _this.attr === 'points') {
      ...
      _this.interpolator = (0, _flubber.interpolate)(_this.start, _this.toPath, {
