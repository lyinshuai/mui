...
exports.initFilterValue = exports.styleValueToArray = exports.getComputedStyle = exports.getValue = exports.getDefaultStart = exports.getAnimatePos = exports.flatArray = exports.dataToArray = exports.getInitProps = exports.initProps = exports.initAnimProps = exports.getTime = exports.windowIsUndefined = exports.colorRegExp = void 0;

function noop() {}

var colorRegExp = /#([0-9a-f]{6}|[0-9a-f]{3})|((rgb|hsl)[a]?)+\(\d+\,[\s+]?\d+\%?\,[\s+]?\d+\%?(\,[\s+]?[0|1](\.?[0-9]+)?)?\)/;
exports.colorRegExp = colorRegExp;
...
exports.initAnimProps = initAnimProps;
var initProps = {
  animation: {},
  paused: false,
  reverse: false,
...
exports.getInitProps = getInitProps;
...
exports.getAnimatePos = getAnimatePos;
...
exports.styleValueToArray = styleValueToArray;
...
exports.initFilterValue = initFilterValue;