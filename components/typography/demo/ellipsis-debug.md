...
```jsx
import { Typography, Slider, Switch } from '@m-design/mui';
      ...
      <>
        ...
        {longText ? (
          <Paragraph ellipsis={{ rows, expandable }} copyable={copyable} editable={editable}>
            M Design, a design language for background applications, is refined by Ant UED Team.
        ...
        <Text style={{ width: 100 }} ellipsis copyable>
          M Design is a design language for background applications, is refined by Ant UED Team.
        </Text>
