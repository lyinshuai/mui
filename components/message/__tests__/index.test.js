...
describe('message', () => {
  ...
  it('should be able to hide manually', () => {
    ...
    expect(document.querySelectorAll('.m-design-message-notice').length).toBe(2);
    hide1();
    jest.runAllTimers();
  ...
  it('should be able to destroy globally', () => {
    ...
    message.info('whatever', 0);
    expect(document.querySelectorAll('.m-design-message').length).toBe(1);
    expect(document.querySelectorAll('.m-design-message-notice').length).toBe(2);
    message.destroy();
    expect(document.querySelectorAll('.m-design-message').length).toBe(0);
    expect(document.querySelectorAll('.m-design-message-notice').length).toBe(0);
  });
  ...
  it('trigger onClick method', () => {
    ...
    mount(<Test />);
    expect(document.querySelectorAll('.m-design-message-notice').length).toBe(1);
    document.querySelectorAll('.m-design-message-notice')[0].click();
  ...
  it('should have no icon', () => {
    ...
    expect(document.querySelectorAll('.m-design-message-notice .anticon').length).toBe(0);
  });
