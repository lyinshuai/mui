...
import { PickerPanel as RCPickerPanel } from '../date-picker/rc-picker';
import { Locale } from '../date-picker/rc-picker/interface';
import { GenerateConfig } from '../date-picker/rc-picker/generate';
import {
...
} from '../date-picker/rc-picker/PickerPanel';
        ...
        return (
          ...
          >
            <div className={`${calendarPrefixCls}-date-value`}>
              {padStart(String(generateConfig.getDate(date)), 2, '')}
            </div>
