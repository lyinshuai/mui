...
```css
.button-demo .m-design-btn,
.button-demo .m-design-btn-group {
  margin-right: 8px;
  margin-bottom: 12px;
}
.button-demo .m-design-btn-group > .m-design-btn,
.button-demo .m-design-btn-group > span > .m-design-btn {
  margin-right: 0;
  margin-left: 0;
}
...
.m-design-badge:not(.m-design-badge-not-a-wrapper) {
  margin-right: 20px;
}
.m-design-badge-rtl:not(.m-design-badge-not-a-wrapper) {
  margin-right: 0;
  margin-left: 20px;
}
```
