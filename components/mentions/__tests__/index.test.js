...
describe('Mentions', () => {
  ...
  it('focus', () => {
    ...
    expect(wrapper.find('.m-design-mentions').hasClass('m-design-mentions-focused')).toBeTruthy();
    expect(onFocus).toHaveBeenCalled();

    wrapper.find('textarea').simulate('blur');
    jest.runAllTimers();
    wrapper.update();
    expect(wrapper.find('.m-design-mentions').hasClass('m-design-mentions-focused')).toBeFalsy();
  ...
  it('loading', () => {
    ...
    expect(wrapper.find('li.m-design-mentions-dropdown-menu-item').length).toBe(1);
    expect(wrapper.find('.m-design-spin').length).toBeTruthy();
  });
