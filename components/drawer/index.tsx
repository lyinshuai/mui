...
import CloseOutlined2 from '../_assets/CloseOutlined2';
  ...
  (
    ...
    const getOffsetStyle = () => {
      ...
      if (placement === 'left' || placement === 'right') {
        const defaultWidth = size === 'large' ? 1000 : 320;
        offsetStyle.width = typeof width === 'undefined' ? defaultWidth : width;
      } else {
        const defaultHeight = size === 'large' ? 1000 : 320;
      ...
      return (
        <div
          className={classNames(`${prefixCls}-header`, {
            [`${prefixCls}-header-close-only`]: closable && !title,
          })}
          style={headerStyle}
        >
    ...
    function renderFooter() {
      ...
      return (
        <div className={footerClassName} style={footerStyle}>
          <div className={`${prefixCls}-footer-content`}>{footer}</div>
