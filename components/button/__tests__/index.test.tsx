...
describe('Button', () => {
  ...
  it('renders Chinese characters correctly in HOC', () => {
    ...
    expect(wrapper.find('.m-design-btn').hasClass('m-design-btn-two-chinese-chars')).toBe(true);
    wrapper.setProps({
      children: <Text>大按钮</Text>,
    });
    wrapper.update();
    expect(wrapper.find('.m-design-btn').hasClass('m-design-btn-two-chinese-chars')).toBe(false);
    wrapper.setProps({
  ...
  it('should change loading state instantly by default', () => {
    ...
    expect(wrapper.find('.m-design-btn-loading').length).toBe(1);
  });
  ...
  it('should change loading state with delay', () => {
    ...
    const wrapper = mount(<DefaultButton />);
    wrapper.simulate('click');
    expect(wrapper.hasClass('m-design-btn-loading')).toBe(false);
  });
  ...
  it('reset when loading back of delay', () => {
    ...
    expect(wrapper.find('.m-design-btn-loading')).toHaveLength(0);
  ...
  it('should support to change loading', async () => {
    ...
    wrapper.setProps({ loading: false });
    wrapper.update();
    expect(wrapper.find('.m-design-btn-loading').length).toBe(0);
