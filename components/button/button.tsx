...
const InternalButton: React.ForwardRefRenderFunction<unknown, ButtonProps> = (props, ref) => {
  ...
  const sizeClassNameMap = { 'x-large': 'xlg', large: 'lg', small: 'sm', middle: undefined };
  ...
  const iconNode =
    icon && !innerLoading ? (
      ...
      <LoadingIcon type={type} ghost={ghost} existIcon={!!icon} prefixCls={prefixCls} loading={!!innerLoading} />
    );
