...
describe('delay spinning', () => {
  it("should render with delay when it's mounted with spinning=true and delay", () => {
    ...
    expect(wrapper.find('.m-design-spin').at(0).hasClass('m-design-spin-spinning')).toEqual(false);
  });
  ...
  it('should render when delay is init set', async () => {
    ...
    expect(wrapper.find('.m-design-spin').at(0).hasClass('m-design-spin-spinning')).toEqual(true);
  });
