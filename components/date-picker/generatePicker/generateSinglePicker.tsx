...
import { PickerMode } from '../rc-picker/interface';
...
export default function generatePicker<DateType>(generateConfig: GenerateConfig<DateType>) {
  ...
  function getPicker<InnerPickerProps extends DatePickerProps>(
    ...
    class Picker extends React.Component<InnerPickerProps> {
        ...
        return (
          <SizeContext.Consumer>
            {size => {
              ...
              return (
                <FormItemStatusContext.Consumer>
                  {({ hasFeedback, status: contextStatus, isSpecified }) => (
                    <RCPicker<DateType>
                      ref={this.pickerRef}
                      ...
                      className={classNames(
                        ...
                        getStatusClassNames(
                          ...
                          hasFeedback,
                          isSpecified || customStatus !== undefined,
                        ),
                        className,
                      )}
                      prefixCls={prefixCls}
      ...
      render() {
        return (
          <LocaleReceiver componentName="DatePicker" defaultLocale={defaultLocale}>
            {this.renderPicker}
          </LocaleReceiver>
        );
      }
