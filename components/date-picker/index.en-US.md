...
import locale from '@m-design/mui/es/date-picker/locale/zh_CN';
...
import 'moment/locale/zh-cn';
import locale from '@m-design/mui/lib/locale/zh_CN';
...
| size | To determine the size of the input box, the height of `large` and `small`, are 36px and 24px respectively, while default size is 32px | `large` \| `middle` \| `small` | - |  |
