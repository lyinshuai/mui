...
```jsx
import { Tabs, Button, Divider, Checkbox } from '@m-design/mui';
...
const operations = (
  <Button type="text" style={{ background: '#f2f3f5', border: 'none' }}>
    Extra Action
  </Button>
);
...
const OperationsSlot = {
  left: (
    <Button
      type="text"
      style={{ background: '#f2f3f5', border: 'none' }}
...
.m-design-row-rtl .tabs-extra-demo-button {
  margin-right: 0;
  margin-left: 16px;
}
```
