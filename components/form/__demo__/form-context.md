...
import { Form, Input, InputNumber, Modal, Button, Avatar, Typography } from '@m-design/mui';
...
ReactDOM.render(<div class="component-form-demo"><Demo /></div>, mountNode);
```
...
#components-form-demo-form-context .user .m-design-avatar {
  margin-right: 8px;
}

.m-design-row-rtl #components-form-demo-form-context .user .m-design-avatar {
  margin-right: 0;
  margin-left: 8px;
}
```
