...
import { FormProps as RcFormProps } from './rc-field-form/Form';
import { ValidateErrorEntity } from './rc-field-form/interface';
...
const InternalForm: React.ForwardRefRenderFunction<FormInstance, FormProps> = (props, ref) => {
  ...
  const mergedColon = colon ?? contextForm?.colon ?? false;
