...
describe('Avatar Render', () => {
  ...
  beforeAll(() => {
    ...
    Object.defineProperty(HTMLElement.prototype, 'offsetWidth', {
      get() {
        if (this.className === 'm-design-avatar-string') {
          return 100;
        }
        return 80;
      },
  ...
  it('Render long string correctly', () => {
    ...
    const children = wrapper.find('.m-design-avatar-string');
  ...
  it('should show image on success after a failure state', () => {
    ...
    expect(wrapper).toMatchSnapshot();
    expect(wrapper.find('.m-design-avatar-string').length).toBe(1);
    // children should show, when image load error without onError return false
    expect(wrapper.find('.m-design-avatar-string').prop('style')).not.toHaveProperty('opacity', 0);
    ...
    expect(wrapper).toMatchSnapshot();
    expect(wrapper.find('.m-design-avatar-image').length).toBe(1);
  ...
  it('should calculate scale of avatar children correctly', () => {
    ...
    expect(wrapper.find('.m-design-avatar-string')).toMatchSnapshot();
