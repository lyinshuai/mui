...
import DragDotVertical from '../_assets/DragDotVertical';
import RcTree, { TreeNode, TreeProps as RcTreeProps, BasicDataNode } from './rc-tree';
import { DataNode, Key } from './rc-tree/interface';
...
const Tree = React.forwardRef<RcTree, TreeProps>((props, ref) => {
  ...
  const draggableConfig = React.useMemo(() => {
    ...
    if (mergedDraggable.icon !== false) {
      mergedDraggable.icon = mergedDraggable.icon || <DragDotVertical />;
    }
