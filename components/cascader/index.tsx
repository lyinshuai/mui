...
import ArrowRightOutlined from '../_assets/ArrowRightOutlined2';
import ArrowLeftOutlined from '../_assets/ArrowLeftOutlined2';
...
const Cascader = React.forwardRef((props: CascaderProps<any>, ref: React.Ref<CascaderRef>) => {
  ...
  // =================== Status =====================
  const { status: contextStatus, hasFeedback, isSpecified } = useContext(FormItemStatusContext);
  ...
  if (!expandIcon) {
    mergedExpandIcon = isRtl ? <ArrowLeftOutlined /> : <ArrowRightOutlined />;
  }
  ...
  return (
    <RcCascader
      ...
      className={classNames(
        ...
        getStatusClassNames(prefixCls, mergedStatus, hasFeedback, mergedIsSpecified),
        className,
      )}
      {...(restProps as any)}
