  ...
  return (
    <RcInput
      ...
      inputClassName={classNames(
        ...
        !inputHasPrefixSuffix && getStatusClassNames(prefixCls, mergedStatus, undefined, mergedIsSpecified),
      )}
      ...
      groupClassName={classNames(
        ...
        getStatusClassNames(`${prefixCls}-group-wrapper`, mergedStatus, hasFeedback, mergedIsSpecified),
      )}
    />
  );
});
