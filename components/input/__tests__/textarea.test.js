...
describe('TextArea', () => {
  ...
  describe('should support showCount', () => {
    it('maxLength', () => {
      ...
      const textarea = wrapper.find('.m-design-input-textarea');
    ...
    describe('emoji', () => {
      it('should minimize value between emoji length and maxLength', () => {
        ...
        const textarea1 = wrapper1.find('.m-design-input-textarea');
    ...
    it('className & style patch to outer', () => {
      ...
      // Inner
      expect(wrapper.find('.m-design-input').hasClass('bamboo')).toBeFalsy();
      expect(wrapper.find('.m-design-input').props().style.background).toBeFalsy();
    });
  ...
  it('should support size', async () => {
    ...
    expect(wrapper.find('textarea').hasClass('m-design-input-lg')).toBe(true);
    expect(wrapper.render()).toMatchSnapshot();
  });
...
describe('TextArea allowClear', () => {
  ...
  it('onChange event should return HTMLTextAreaElement', () => {
    ...
    // Reset
    wrapper.find('.m-design-input-clear-icon').first().simulate('click');
    isNativeElement();
  });
  ...
  it('should not lost focus when clear input', () => {
    ...
    wrapper.find('.m-design-input-clear-icon').at(0).getDOMNode().click();
