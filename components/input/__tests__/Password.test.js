...
describe('Input.Password', () => {
  ...
  it('should support size', () => {
    ...
    expect(wrapper.find('.m-design-input-affix-wrapper-lg')).toBeTruthy();
  ...
  it('should change type when click', () => {
    ...
    expect(wrapper.render()).toMatchSnapshot();
    wrapper.find('.m-design-input-password-icon').at(0).simulate('click');
    expect(wrapper.render()).toMatchSnapshot();
    wrapper.find('.m-design-input-password-icon').at(0).simulate('click');
    expect(wrapper.render()).toMatchSnapshot();
  });
  ...
  it('should keep focus state', () => {
    ...
    wrapper.find('.m-design-input-password-icon').at(0).simulate('mousedown');
    wrapper.find('.m-design-input-password-icon').at(0).simulate('mouseup');
    wrapper.find('.m-design-input-password-icon').at(0).simulate('click');
    expect(document.activeElement).toBe(wrapper.find('input').at(0).getDOMNode());
    expect(document.activeElement.selectionStart).toBe(2);
    wrapper.unmount();
