...
import { TableProps as RcTableProps, INTERNAL_HOOKS } from './rc-table/Table';
import { convertChildrenToColumns } from './rc-table/hooks/useColumns';
...
function InternalTable<RecordType extends object = any>(
  ...
  const size = React.useContext(SizeContext) as SizeType & 'x-large';
  const {
  ...
  if (pagination !== false && mergedPagination?.total) {
    ...
    if (mergedPagination.size) {
      ...
      paginationSize = mergedSize === 'small' ? 'small' : undefined;
    }
    ...
    <div ref={ref} className={wrapperClassNames} style={style}>
      <Spin spinning={false} {...spinProps}>
        ...
        <RcTable<RecordType>
          ...
          prefixCls={prefixCls}
          className={classNames({
            [`${prefixCls}-x-large`]: mergedSize === 'x-large',
