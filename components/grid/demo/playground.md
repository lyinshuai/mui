...
```jsx
import { Row, Col, Slider } from '@m-design/mui';
...
```css
#components-grid-demo-playground [class~='m-design-col'] {
  background: transparent;
  border: 0;
}
#components-grid-demo-playground [class~='m-design-col'] > div {
  height: 120px;
  font-size: 14px;
  line-height: 120px;
  background: #0092ff;
...
#components-grid-demo-playground .m-design-col {
  padding: 0;
}
```

<style>
[data-theme="dark"] #components-grid-demo-playground [class~='m-design-col'] > div {
  background: #028ac8;
}
</style>
