...
if (typeof window !== 'undefined') {
  ...
  window['@m-design/mui'] = require('@m-design/mui');
  // eslint-disable-next-line global-require
  ...
  render() {
    ...
    const title =
      appLocale.locale === 'zh-CN'
        ? 'M Design - 一套企业级 UI 设计语言和 React 组件库'
        : "M Design - The world's second most popular React UI framework";
    const description =
      appLocale.locale === 'zh-CN'
        ? '基于 M Design 设计体系的 React UI 组件库，用于研发企业级中后台产品。'
