...
The default language of `mui` is currently English. If you wish to use other languages, follow the instructions below.

## ConfigProvider

`mui` provides a React Component [ConfigProvider](/components/config-provider) for configuring antd locale text globally.

```jsx
import { ConfigProvider } from '@m-design/mui';
import frFR from '@m-design/mui/lib/locale/fr_FR';
